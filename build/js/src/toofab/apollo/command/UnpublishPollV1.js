...
export default class UnpublishPollV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:apollo:command:unpublish-poll:1-0-0', UnpublishPollV1,
      [],
      [
...
MessageResolver.register('toofab:apollo:command:unpublish-poll', UnpublishPollV1);
