...
export default class MarkPollAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:apollo:command:mark-poll-as-pending:1-0-0', MarkPollAsPendingV1,
      [],
      [
...
MessageResolver.register('toofab:apollo:command:mark-poll-as-pending', MarkPollAsPendingV1);
