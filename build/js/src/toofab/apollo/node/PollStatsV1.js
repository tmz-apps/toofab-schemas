// @link https://schemas.toofab.com/json-schema/toofab/apollo/node/poll-stats/1-0-0.json#
...
export default class PollStatsV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:apollo:node:poll-stats:1-0-0', PollStatsV1,
      [],
      [
...
MessageResolver.register('toofab:apollo:node:poll-stats', PollStatsV1);
