// @link https://schemas.toofab.com/json-schema/toofab/apollo/node/poll/1-0-0.json#
...
export default class PollV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:apollo:node:poll:1-0-0', PollV1,
      [],
      [
...
MessageResolver.register('toofab:apollo:node:poll', PollV1);
