...
export default class AppRolesRevokedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:iam:event:app-roles-revoked:1-0-0', AppRolesRevokedV1,
      [],
      [
...
MessageResolver.register('toofab:iam:event:app-roles-revoked', AppRolesRevokedV1);
