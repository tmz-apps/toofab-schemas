...
export default class GetAppHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:iam:request:get-app-history-request:1-0-0', GetAppHistoryRequestV1,
      [],
      [
...
MessageResolver.register('toofab:iam:request:get-app-history-request', GetAppHistoryRequestV1);
