...
export default class GetUserResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:iam:request:get-user-response:1-0-0', GetUserResponseV1,
      [],
      [
...
MessageResolver.register('toofab:iam:request:get-user-response', GetUserResponseV1);
