...
export default class GetUserHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:iam:request:get-user-history-request:1-0-0', GetUserHistoryRequestV1,
      [],
      [
...
MessageResolver.register('toofab:iam:request:get-user-history-request', GetUserHistoryRequestV1);
