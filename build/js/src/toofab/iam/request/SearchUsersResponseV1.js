...
export default class SearchUsersResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:iam:request:search-users-response:1-0-0', SearchUsersResponseV1,
      [],
      [
...
MessageResolver.register('toofab:iam:request:search-users-response', SearchUsersResponseV1);
