// @link https://schemas.toofab.com/json-schema/toofab/iam/command/grant-roles-to-user/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:toofab:iam:command:grant-roles-to-user:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'toofab:iam:command:grant-roles-to-user';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'toofab:iam:command:grant-roles-to-user:v1';
