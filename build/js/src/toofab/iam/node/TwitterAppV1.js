// @link https://schemas.toofab.com/json-schema/toofab/iam/node/twitter-app/1-0-0.json#
...
export default class TwitterAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:iam:node:twitter-app:1-0-0', TwitterAppV1,
      [],
      [
...
MessageResolver.register('toofab:iam:node:twitter-app', TwitterAppV1);
