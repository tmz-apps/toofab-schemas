// @link https://schemas.toofab.com/json-schema/toofab/iam/node/alexa-app/1-0-0.json#
...
export default class AlexaAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:iam:node:alexa-app:1-0-0', AlexaAppV1,
      [],
      [
...
MessageResolver.register('toofab:iam:node:alexa-app', AlexaAppV1);
