// @link https://schemas.toofab.com/json-schema/toofab/iam/node/apple-news-app/1-0-0.json#
...
export default class AppleNewsAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:iam:node:apple-news-app:1-0-0', AppleNewsAppV1,
      [],
      [
...
MessageResolver.register('toofab:iam:node:apple-news-app', AppleNewsAppV1);
