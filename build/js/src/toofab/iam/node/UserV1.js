// @link https://schemas.toofab.com/json-schema/toofab/iam/node/user/1-0-0.json#
...
export default class UserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:iam:node:user:1-0-0', UserV1,
      [],
      [
...
MessageResolver.register('toofab:iam:node:user', UserV1);
