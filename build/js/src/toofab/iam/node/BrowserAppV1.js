// @link https://schemas.toofab.com/json-schema/toofab/iam/node/browser-app/1-0-0.json#
...
export default class BrowserAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:iam:node:browser-app:1-0-0', BrowserAppV1,
      [],
      [
...
MessageResolver.register('toofab:iam:node:browser-app', BrowserAppV1);
