// @link https://schemas.toofab.com/json-schema/toofab/iam/node/email-app/1-0-0.json#
...
export default class EmailAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:iam:node:email-app:1-0-0', EmailAppV1,
      [],
      [
...
MessageResolver.register('toofab:iam:node:email-app', EmailAppV1);
