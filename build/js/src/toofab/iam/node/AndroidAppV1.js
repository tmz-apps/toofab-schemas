// @link https://schemas.toofab.com/json-schema/toofab/iam/node/android-app/1-0-0.json#
...
export default class AndroidAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:iam:node:android-app:1-0-0', AndroidAppV1,
      [],
      [
...
MessageResolver.register('toofab:iam:node:android-app', AndroidAppV1);
