// @link https://schemas.toofab.com/json-schema/toofab/iam/node/ios-app/1-0-0.json#
...
export default class IosAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:iam:node:ios-app:1-0-0', IosAppV1,
      [],
      [
...
MessageResolver.register('toofab:iam:node:ios-app', IosAppV1);
