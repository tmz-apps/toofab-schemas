// @link https://schemas.toofab.com/json-schema/toofab/iam/node/slack-app/1-0-0.json#
...
export default class SlackAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:iam:node:slack-app:1-0-0', SlackAppV1,
      [],
      [
...
MessageResolver.register('toofab:iam:node:slack-app', SlackAppV1);
