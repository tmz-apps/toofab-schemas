// @link https://schemas.toofab.com/json-schema/toofab/iam/node/sms-app/1-0-0.json#
...
export default class SmsAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:iam:node:sms-app:1-0-0', SmsAppV1,
      [],
      [
...
MessageResolver.register('toofab:iam:node:sms-app', SmsAppV1);
