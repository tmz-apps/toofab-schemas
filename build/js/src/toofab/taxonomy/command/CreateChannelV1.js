...
export default class CreateChannelV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:taxonomy:command:create-channel:1-0-0', CreateChannelV1,
      [],
      [
...
MessageResolver.register('toofab:taxonomy:command:create-channel', CreateChannelV1);
