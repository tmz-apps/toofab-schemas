...
export default class GetCategoryHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:taxonomy:request:get-category-history-request:1-0-0', GetCategoryHistoryRequestV1,
      [],
      [
...
MessageResolver.register('toofab:taxonomy:request:get-category-history-request', GetCategoryHistoryRequestV1);
