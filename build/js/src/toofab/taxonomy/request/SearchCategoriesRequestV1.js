...
export default class SearchCategoriesRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:taxonomy:request:search-categories-request:1-0-0', SearchCategoriesRequestV1,
      [],
      [
...
MessageResolver.register('toofab:taxonomy:request:search-categories-request', SearchCategoriesRequestV1);
