...
export default class GetChannelHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:taxonomy:request:get-channel-history-request:1-0-0', GetChannelHistoryRequestV1,
      [],
      [
...
MessageResolver.register('toofab:taxonomy:request:get-channel-history-request', GetChannelHistoryRequestV1);
