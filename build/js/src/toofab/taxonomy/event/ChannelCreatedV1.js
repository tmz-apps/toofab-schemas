...
export default class ChannelCreatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:taxonomy:event:channel-created:1-0-0', ChannelCreatedV1,
      [],
      [
...
MessageResolver.register('toofab:taxonomy:event:channel-created', ChannelCreatedV1);
