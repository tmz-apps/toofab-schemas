...
export default class ChannelDeletedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:taxonomy:event:channel-deleted:1-0-0', ChannelDeletedV1,
      [],
      [
...
MessageResolver.register('toofab:taxonomy:event:channel-deleted', ChannelDeletedV1);
