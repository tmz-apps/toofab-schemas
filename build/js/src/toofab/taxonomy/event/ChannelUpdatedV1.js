...
export default class ChannelUpdatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:taxonomy:event:channel-updated:1-0-0', ChannelUpdatedV1,
      [],
      [
...
MessageResolver.register('toofab:taxonomy:event:channel-updated', ChannelUpdatedV1);
