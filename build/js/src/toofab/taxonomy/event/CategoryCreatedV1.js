...
export default class CategoryCreatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:taxonomy:event:category-created:1-0-0', CategoryCreatedV1,
      [],
      [
...
MessageResolver.register('toofab:taxonomy:event:category-created', CategoryCreatedV1);
