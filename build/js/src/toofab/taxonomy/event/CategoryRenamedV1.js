...
export default class CategoryRenamedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:taxonomy:event:category-renamed:1-0-0', CategoryRenamedV1,
      [],
      [
...
MessageResolver.register('toofab:taxonomy:event:category-renamed', CategoryRenamedV1);
