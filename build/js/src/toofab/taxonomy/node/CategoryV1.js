// @link https://schemas.toofab.com/json-schema/toofab/taxonomy/node/category/1-0-0.json#
...
export default class CategoryV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:taxonomy:node:category:1-0-0', CategoryV1,
      [],
      [
...
MessageResolver.register('toofab:taxonomy:node:category', CategoryV1);
