// @link https://schemas.toofab.com/json-schema/toofab/taxonomy/node/channel/1-0-0.json#
...
export default class ChannelV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:taxonomy:node:channel:1-0-0', ChannelV1,
      [],
      [
...
MessageResolver.register('toofab:taxonomy:node:channel', ChannelV1);
