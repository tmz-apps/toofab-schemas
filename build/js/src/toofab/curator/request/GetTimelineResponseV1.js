...
export default class GetTimelineResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:request:get-timeline-response:1-0-0', GetTimelineResponseV1,
      [],
      [
...
MessageResolver.register('toofab:curator:request:get-timeline-response', GetTimelineResponseV1);
