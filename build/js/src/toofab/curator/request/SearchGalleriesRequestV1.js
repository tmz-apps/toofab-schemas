...
export default class SearchGalleriesRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:request:search-galleries-request:1-0-0', SearchGalleriesRequestV1,
      [],
      [
...
MessageResolver.register('toofab:curator:request:search-galleries-request', SearchGalleriesRequestV1);
