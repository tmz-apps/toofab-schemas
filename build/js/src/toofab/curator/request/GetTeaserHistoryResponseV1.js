...
export default class GetTeaserHistoryResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:request:get-teaser-history-response:1-0-0', GetTeaserHistoryResponseV1,
      [],
      [
...
MessageResolver.register('toofab:curator:request:get-teaser-history-response', GetTeaserHistoryResponseV1);
