...
export default class GetTimelineHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:request:get-timeline-history-request:1-0-0', GetTimelineHistoryRequestV1,
      [],
      [
...
MessageResolver.register('toofab:curator:request:get-timeline-history-request', GetTimelineHistoryRequestV1);
