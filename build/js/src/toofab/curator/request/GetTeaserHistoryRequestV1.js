...
export default class GetTeaserHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:request:get-teaser-history-request:1-0-0', GetTeaserHistoryRequestV1,
      [],
      [
...
MessageResolver.register('toofab:curator:request:get-teaser-history-request', GetTeaserHistoryRequestV1);
