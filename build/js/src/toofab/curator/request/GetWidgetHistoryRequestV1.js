...
export default class GetWidgetHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:request:get-widget-history-request:1-0-0', GetWidgetHistoryRequestV1,
      [],
      [
...
MessageResolver.register('toofab:curator:request:get-widget-history-request', GetWidgetHistoryRequestV1);
