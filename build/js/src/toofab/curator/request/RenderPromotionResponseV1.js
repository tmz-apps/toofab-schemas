...
export default class RenderPromotionResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:request:render-promotion-response:1-0-0', RenderPromotionResponseV1,
      [],
      [
...
MessageResolver.register('toofab:curator:request:render-promotion-response', RenderPromotionResponseV1);
