...
export default class SearchTimelinesResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:request:search-timelines-response:1-0-0', SearchTimelinesResponseV1,
      [],
      [
...
MessageResolver.register('toofab:curator:request:search-timelines-response', SearchTimelinesResponseV1);
