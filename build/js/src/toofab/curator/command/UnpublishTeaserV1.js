...
export default class UnpublishTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:command:unpublish-teaser:1-0-0', UnpublishTeaserV1,
      [],
      [
...
MessageResolver.register('toofab:curator:command:unpublish-teaser', UnpublishTeaserV1);
