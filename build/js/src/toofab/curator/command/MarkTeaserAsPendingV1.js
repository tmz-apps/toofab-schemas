...
export default class MarkTeaserAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:command:mark-teaser-as-pending:1-0-0', MarkTeaserAsPendingV1,
      [],
      [
...
MessageResolver.register('toofab:curator:command:mark-teaser-as-pending', MarkTeaserAsPendingV1);
