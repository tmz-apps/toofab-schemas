...
export default class MarkTimelineAsDraftV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:command:mark-timeline-as-draft:1-0-0', MarkTimelineAsDraftV1,
      [],
      [
...
MessageResolver.register('toofab:curator:command:mark-timeline-as-draft', MarkTimelineAsDraftV1);
