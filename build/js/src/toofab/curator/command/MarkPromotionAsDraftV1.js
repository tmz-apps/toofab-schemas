...
export default class MarkPromotionAsDraftV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:command:mark-promotion-as-draft:1-0-0', MarkPromotionAsDraftV1,
      [],
      [
...
MessageResolver.register('toofab:curator:command:mark-promotion-as-draft', MarkPromotionAsDraftV1);
