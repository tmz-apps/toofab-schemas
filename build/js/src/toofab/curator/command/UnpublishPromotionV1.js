...
export default class UnpublishPromotionV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:command:unpublish-promotion:1-0-0', UnpublishPromotionV1,
      [],
      [
...
MessageResolver.register('toofab:curator:command:unpublish-promotion', UnpublishPromotionV1);
