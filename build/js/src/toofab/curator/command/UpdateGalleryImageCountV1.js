...
export default class UpdateGalleryImageCountV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:command:update-gallery-image-count:1-0-0', UpdateGalleryImageCountV1,
      [],
      [
...
MessageResolver.register('toofab:curator:command:update-gallery-image-count', UpdateGalleryImageCountV1);
