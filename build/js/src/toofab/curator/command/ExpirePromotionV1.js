...
export default class ExpirePromotionV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:command:expire-promotion:1-0-0', ExpirePromotionV1,
      [],
      [
...
MessageResolver.register('toofab:curator:command:expire-promotion', ExpirePromotionV1);
