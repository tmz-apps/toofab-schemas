...
export default class DeleteWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:command:delete-widget:1-0-0', DeleteWidgetV1,
      [],
      [
...
MessageResolver.register('toofab:curator:command:delete-widget', DeleteWidgetV1);
