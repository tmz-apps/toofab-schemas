...
export default class ExpireGalleryV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:command:expire-gallery:1-0-0', ExpireGalleryV1,
      [],
      [
...
MessageResolver.register('toofab:curator:command:expire-gallery', ExpireGalleryV1);
