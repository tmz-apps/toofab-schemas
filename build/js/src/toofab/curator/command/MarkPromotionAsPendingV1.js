...
export default class MarkPromotionAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:command:mark-promotion-as-pending:1-0-0', MarkPromotionAsPendingV1,
      [],
      [
...
MessageResolver.register('toofab:curator:command:mark-promotion-as-pending', MarkPromotionAsPendingV1);
