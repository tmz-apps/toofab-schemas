...
export default class PublishTimelineV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:command:publish-timeline:1-0-0', PublishTimelineV1,
      [],
      [
...
MessageResolver.register('toofab:curator:command:publish-timeline', PublishTimelineV1);
