...
export default class MarkGalleryAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:command:mark-gallery-as-pending:1-0-0', MarkGalleryAsPendingV1,
      [],
      [
...
MessageResolver.register('toofab:curator:command:mark-gallery-as-pending', MarkGalleryAsPendingV1);
