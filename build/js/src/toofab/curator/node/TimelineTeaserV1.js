// @link https://schemas.toofab.com/json-schema/toofab/curator/node/timeline-teaser/1-0-0.json#
...
export default class TimelineTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:node:timeline-teaser:1-0-0', TimelineTeaserV1,
      [],
      [
...
MessageResolver.register('toofab:curator:node:timeline-teaser', TimelineTeaserV1);
