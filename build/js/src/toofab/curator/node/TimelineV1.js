// @link https://schemas.toofab.com/json-schema/toofab/curator/node/timeline/1-0-0.json#
...
export default class TimelineV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:node:timeline:1-0-0', TimelineV1,
      [],
      [
...
MessageResolver.register('toofab:curator:node:timeline', TimelineV1);
