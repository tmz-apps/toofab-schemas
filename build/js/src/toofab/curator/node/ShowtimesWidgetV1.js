// @link https://schemas.toofab.com/json-schema/toofab/curator/node/showtimes-widget/1-0-0.json#
...
export default class ShowtimesWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:node:showtimes-widget:1-0-0', ShowtimesWidgetV1,
      [],
      [
...
MessageResolver.register('toofab:curator:node:showtimes-widget', ShowtimesWidgetV1);
