// @link https://schemas.toofab.com/json-schema/toofab/curator/node/hero-bar-widget/1-0-0.json#
...
export default class HeroBarWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:node:hero-bar-widget:1-0-0', HeroBarWidgetV1,
      [],
      [
...
MessageResolver.register('toofab:curator:node:hero-bar-widget', HeroBarWidgetV1);
