// @link https://schemas.toofab.com/json-schema/toofab/curator/node/promotion/1-0-0.json#
...
export default class PromotionV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:node:promotion:1-0-0', PromotionV1,
      [],
      [
...
MessageResolver.register('toofab:curator:node:promotion', PromotionV1);
