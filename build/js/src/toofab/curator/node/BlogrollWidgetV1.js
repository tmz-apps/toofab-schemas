// @link https://schemas.toofab.com/json-schema/toofab/curator/node/blogroll-widget/1-0-0.json#
...
export default class BlogrollWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:node:blogroll-widget:1-0-0', BlogrollWidgetV1,
      [],
      [
...
MessageResolver.register('toofab:curator:node:blogroll-widget', BlogrollWidgetV1);
