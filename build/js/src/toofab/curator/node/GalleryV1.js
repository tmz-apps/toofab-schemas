// @link https://schemas.toofab.com/json-schema/toofab/curator/node/gallery/1-0-0.json#
...
export default class GalleryV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:node:gallery:1-0-0', GalleryV1,
      [],
      [
...
MessageResolver.register('toofab:curator:node:gallery', GalleryV1);
