// @link https://schemas.toofab.com/json-schema/toofab/curator/node/ad-widget/1-0-0.json#
...
export default class AdWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:node:ad-widget:1-0-0', AdWidgetV1,
      [],
      [
...
MessageResolver.register('toofab:curator:node:ad-widget', AdWidgetV1);
