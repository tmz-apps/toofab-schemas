// @link https://schemas.toofab.com/json-schema/toofab/curator/node/article-teaser/1-0-0.json#
...
export default class ArticleTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:node:article-teaser:1-0-0', ArticleTeaserV1,
      [],
      [
...
MessageResolver.register('toofab:curator:node:article-teaser', ArticleTeaserV1);
