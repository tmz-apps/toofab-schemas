// @link https://schemas.toofab.com/json-schema/toofab/curator/node/code-widget/1-0-0.json#
...
export default class CodeWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:node:code-widget:1-0-0', CodeWidgetV1,
      [],
      [
...
MessageResolver.register('toofab:curator:node:code-widget', CodeWidgetV1);
