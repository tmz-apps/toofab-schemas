// @link https://schemas.toofab.com/json-schema/toofab/curator/node/channel-teaser/1-0-0.json#
...
export default class ChannelTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:node:channel-teaser:1-0-0', ChannelTeaserV1,
      [],
      [
...
MessageResolver.register('toofab:curator:node:channel-teaser', ChannelTeaserV1);
