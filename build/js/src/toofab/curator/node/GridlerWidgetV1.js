// @link https://schemas.toofab.com/json-schema/toofab/curator/node/gridler-widget/1-0-0.json#
...
export default class GridlerWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:node:gridler-widget:1-0-0', GridlerWidgetV1,
      [],
      [
...
MessageResolver.register('toofab:curator:node:gridler-widget', GridlerWidgetV1);
