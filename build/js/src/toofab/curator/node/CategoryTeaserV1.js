// @link https://schemas.toofab.com/json-schema/toofab/curator/node/category-teaser/1-0-0.json#
...
export default class CategoryTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:node:category-teaser:1-0-0', CategoryTeaserV1,
      [],
      [
...
MessageResolver.register('toofab:curator:node:category-teaser', CategoryTeaserV1);
