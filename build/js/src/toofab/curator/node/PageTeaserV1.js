// @link https://schemas.toofab.com/json-schema/toofab/curator/node/page-teaser/1-0-0.json#
...
export default class PageTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:node:page-teaser:1-0-0', PageTeaserV1,
      [],
      [
...
MessageResolver.register('toofab:curator:node:page-teaser', PageTeaserV1);
