// @link https://schemas.toofab.com/json-schema/toofab/curator/node/spotlight-widget/1-0-0.json#
...
export default class SpotlightWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:node:spotlight-widget:1-0-0', SpotlightWidgetV1,
      [],
      [
...
MessageResolver.register('toofab:curator:node:spotlight-widget', SpotlightWidgetV1);
