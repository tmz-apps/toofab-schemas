// @link https://schemas.toofab.com/json-schema/toofab/curator/node/gallery-widget/1-0-0.json#
...
export default class GalleryWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:node:gallery-widget:1-0-0', GalleryWidgetV1,
      [],
      [
...
MessageResolver.register('toofab:curator:node:gallery-widget', GalleryWidgetV1);
