// @link https://schemas.toofab.com/json-schema/toofab/curator/node/carousel-widget/1-0-0.json#
...
export default class CarouselWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:node:carousel-widget:1-0-0', CarouselWidgetV1,
      [],
      [
...
MessageResolver.register('toofab:curator:node:carousel-widget', CarouselWidgetV1);
