// @link https://schemas.toofab.com/json-schema/toofab/curator/node/link-teaser/1-0-0.json#
...
export default class LinkTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:node:link-teaser:1-0-0', LinkTeaserV1,
      [],
      [
...
MessageResolver.register('toofab:curator:node:link-teaser', LinkTeaserV1);
