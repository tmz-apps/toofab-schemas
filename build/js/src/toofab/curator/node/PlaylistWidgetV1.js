// @link https://schemas.toofab.com/json-schema/toofab/curator/node/playlist-widget/1-0-0.json#
...
export default class PlaylistWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:node:playlist-widget:1-0-0', PlaylistWidgetV1,
      [],
      [
...
MessageResolver.register('toofab:curator:node:playlist-widget', PlaylistWidgetV1);
