// @link https://schemas.toofab.com/json-schema/toofab/curator/node/gallery-teaser/1-0-0.json#
...
export default class GalleryTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:node:gallery-teaser:1-0-0', GalleryTeaserV1,
      [],
      [
...
MessageResolver.register('toofab:curator:node:gallery-teaser', GalleryTeaserV1);
