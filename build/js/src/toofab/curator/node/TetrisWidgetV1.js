// @link https://schemas.toofab.com/json-schema/toofab/curator/node/tetris-widget/1-0-0.json#
...
export default class TetrisWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:node:tetris-widget:1-0-0', TetrisWidgetV1,
      [],
      [
...
MessageResolver.register('toofab:curator:node:tetris-widget', TetrisWidgetV1);
