// @link https://schemas.toofab.com/json-schema/toofab/curator/node/poll-teaser/1-0-0.json#
...
export default class PollTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:node:poll-teaser:1-0-0', PollTeaserV1,
      [],
      [
...
MessageResolver.register('toofab:curator:node:poll-teaser', PollTeaserV1);
