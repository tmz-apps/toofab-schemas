...
export default class TeaserMarkedAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:event:teaser-marked-as-pending:1-0-0', TeaserMarkedAsPendingV1,
      [],
      [
...
MessageResolver.register('toofab:curator:event:teaser-marked-as-pending', TeaserMarkedAsPendingV1);
