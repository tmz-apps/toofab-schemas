...
export default class TeaserSlottingRemovedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:event:teaser-slotting-removed:1-0-0', TeaserSlottingRemovedV1,
      [],
      [
...
MessageResolver.register('toofab:curator:event:teaser-slotting-removed', TeaserSlottingRemovedV1);
