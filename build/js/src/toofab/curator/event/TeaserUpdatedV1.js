...
export default class TeaserUpdatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:event:teaser-updated:1-0-0', TeaserUpdatedV1,
      [],
      [
...
MessageResolver.register('toofab:curator:event:teaser-updated', TeaserUpdatedV1);
