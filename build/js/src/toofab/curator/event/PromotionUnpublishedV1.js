...
export default class PromotionUnpublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:event:promotion-unpublished:1-0-0', PromotionUnpublishedV1,
      [],
      [
...
MessageResolver.register('toofab:curator:event:promotion-unpublished', PromotionUnpublishedV1);
