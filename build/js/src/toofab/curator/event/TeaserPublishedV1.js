...
export default class TeaserPublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:event:teaser-published:1-0-0', TeaserPublishedV1,
      [],
      [
...
MessageResolver.register('toofab:curator:event:teaser-published', TeaserPublishedV1);
