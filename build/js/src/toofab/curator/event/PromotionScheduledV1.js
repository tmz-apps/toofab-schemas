...
export default class PromotionScheduledV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:event:promotion-scheduled:1-0-0', PromotionScheduledV1,
      [],
      [
...
MessageResolver.register('toofab:curator:event:promotion-scheduled', PromotionScheduledV1);
