...
export default class TeaserUnpublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:curator:event:teaser-unpublished:1-0-0', TeaserUnpublishedV1,
      [],
      [
...
MessageResolver.register('toofab:curator:event:teaser-unpublished', TeaserUnpublishedV1);
