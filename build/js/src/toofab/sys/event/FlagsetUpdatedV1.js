...
export default class FlagsetUpdatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:sys:event:flagset-updated:1-0-0', FlagsetUpdatedV1,
      [],
      [
...
MessageResolver.register('toofab:sys:event:flagset-updated', FlagsetUpdatedV1);
