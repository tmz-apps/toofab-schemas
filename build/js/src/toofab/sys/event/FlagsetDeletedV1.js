...
export default class FlagsetDeletedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:sys:event:flagset-deleted:1-0-0', FlagsetDeletedV1,
      [],
      [
...
MessageResolver.register('toofab:sys:event:flagset-deleted', FlagsetDeletedV1);
