...
export default class PicklistCreatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:sys:event:picklist-created:1-0-0', PicklistCreatedV1,
      [],
      [
...
MessageResolver.register('toofab:sys:event:picklist-created', PicklistCreatedV1);
