...
export default class RedirectUpdatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:sys:event:redirect-updated:1-0-0', RedirectUpdatedV1,
      [],
      [
...
MessageResolver.register('toofab:sys:event:redirect-updated', RedirectUpdatedV1);
