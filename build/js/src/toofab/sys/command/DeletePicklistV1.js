...
export default class DeletePicklistV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:sys:command:delete-picklist:1-0-0', DeletePicklistV1,
      [],
      [
...
MessageResolver.register('toofab:sys:command:delete-picklist', DeletePicklistV1);
