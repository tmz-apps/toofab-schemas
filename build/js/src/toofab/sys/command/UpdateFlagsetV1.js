...
export default class UpdateFlagsetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:sys:command:update-flagset:1-0-0', UpdateFlagsetV1,
      [],
      [
...
MessageResolver.register('toofab:sys:command:update-flagset', UpdateFlagsetV1);
