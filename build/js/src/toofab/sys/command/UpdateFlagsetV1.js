// @link https://schemas.toofab.com/json-schema/toofab/sys/command/update-flagset/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:toofab:sys:command:update-flagset:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'toofab:sys:command:update-flagset';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'toofab:sys:command:update-flagset:v1';
