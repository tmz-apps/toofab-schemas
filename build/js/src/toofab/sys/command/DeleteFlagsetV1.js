...
export default class DeleteFlagsetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:sys:command:delete-flagset:1-0-0', DeleteFlagsetV1,
      [],
      [
...
MessageResolver.register('toofab:sys:command:delete-flagset', DeleteFlagsetV1);
