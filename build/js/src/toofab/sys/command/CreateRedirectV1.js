// @link https://schemas.toofab.com/json-schema/toofab/sys/command/create-redirect/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:toofab:sys:command:create-redirect:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'toofab:sys:command:create-redirect';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'toofab:sys:command:create-redirect:v1';
