...
export default class CreateFlagsetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:sys:command:create-flagset:1-0-0', CreateFlagsetV1,
      [],
      [
...
MessageResolver.register('toofab:sys:command:create-flagset', CreateFlagsetV1);
