...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:toofab:sys:request:list-all-flagsets-request:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'toofab:sys:request:list-all-flagsets-request';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'toofab:sys:request:list-all-flagsets-request:v1';
