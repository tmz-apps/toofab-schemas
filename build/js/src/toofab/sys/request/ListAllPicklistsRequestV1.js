...
export default class ListAllPicklistsRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:sys:request:list-all-picklists-request:1-0-0', ListAllPicklistsRequestV1,
      [],
      [
...
MessageResolver.register('toofab:sys:request:list-all-picklists-request', ListAllPicklistsRequestV1);
