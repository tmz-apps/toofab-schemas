...
export default class GetRedirectHistoryResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:sys:request:get-redirect-history-response:1-0-0', GetRedirectHistoryResponseV1,
      [],
      [
...
MessageResolver.register('toofab:sys:request:get-redirect-history-response', GetRedirectHistoryResponseV1);
