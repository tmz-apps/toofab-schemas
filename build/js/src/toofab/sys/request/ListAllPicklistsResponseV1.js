...
export default class ListAllPicklistsResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:sys:request:list-all-picklists-response:1-0-0', ListAllPicklistsResponseV1,
      [],
      [
...
MessageResolver.register('toofab:sys:request:list-all-picklists-response', ListAllPicklistsResponseV1);
