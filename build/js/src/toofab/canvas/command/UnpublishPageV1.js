...
export default class UnpublishPageV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:canvas:command:unpublish-page:1-0-0', UnpublishPageV1,
      [],
      [
...
MessageResolver.register('toofab:canvas:command:unpublish-page', UnpublishPageV1);
