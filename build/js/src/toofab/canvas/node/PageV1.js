// @link https://schemas.toofab.com/json-schema/toofab/canvas/node/page/1-0-0.json#
...
export default class PageV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:canvas:node:page:1-0-0', PageV1,
      [],
      [
...
MessageResolver.register('toofab:canvas:node:page', PageV1);
