// @link https://schemas.toofab.com/json-schema/toofab/canvas/event/page-scheduled/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:toofab:canvas:event:page-scheduled:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'toofab:canvas:event:page-scheduled';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'toofab:canvas:event:page-scheduled:v1';
