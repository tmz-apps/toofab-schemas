...
export default class PageScheduledV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:canvas:event:page-scheduled:1-0-0', PageScheduledV1,
      [],
      [
...
MessageResolver.register('toofab:canvas:event:page-scheduled', PageScheduledV1);
