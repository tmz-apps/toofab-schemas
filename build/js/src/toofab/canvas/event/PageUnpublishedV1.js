...
export default class PageUnpublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:canvas:event:page-unpublished:1-0-0', PageUnpublishedV1,
      [],
      [
...
MessageResolver.register('toofab:canvas:event:page-unpublished', PageUnpublishedV1);
