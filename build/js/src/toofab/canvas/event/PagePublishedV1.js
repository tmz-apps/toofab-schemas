...
export default class PagePublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:canvas:event:page-published:1-0-0', PagePublishedV1,
      [],
      [
...
MessageResolver.register('toofab:canvas:event:page-published', PagePublishedV1);
