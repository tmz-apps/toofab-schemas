...
export default class GoogleMapBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:canvas:block:google-map-block:1-0-0', GoogleMapBlockV1,
      [],
      [
...
MessageResolver.register('toofab:canvas:block:google-map-block', GoogleMapBlockV1);
