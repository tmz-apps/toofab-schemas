...
export default class YoutubePlaylistBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:canvas:block:youtube-playlist-block:1-0-0', YoutubePlaylistBlockV1,
      [],
      [
...
MessageResolver.register('toofab:canvas:block:youtube-playlist-block', YoutubePlaylistBlockV1);
