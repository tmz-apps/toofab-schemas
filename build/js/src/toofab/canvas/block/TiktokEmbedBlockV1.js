...
export default class TiktokEmbedBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:canvas:block:tiktok-embed-block:1-0-0', TiktokEmbedBlockV1,
      [],
      [
...
MessageResolver.register('toofab:canvas:block:tiktok-embed-block', TiktokEmbedBlockV1);
