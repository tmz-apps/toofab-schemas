...
export default class TwitterTweetBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:canvas:block:twitter-tweet-block:1-0-0', TwitterTweetBlockV1,
      [],
      [
...
MessageResolver.register('toofab:canvas:block:twitter-tweet-block', TwitterTweetBlockV1);
