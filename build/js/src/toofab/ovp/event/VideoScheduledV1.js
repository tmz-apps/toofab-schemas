...
export default class VideoScheduledV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:ovp:event:video-scheduled:1-0-0', VideoScheduledV1,
      [],
      [
...
MessageResolver.register('toofab:ovp:event:video-scheduled', VideoScheduledV1);
