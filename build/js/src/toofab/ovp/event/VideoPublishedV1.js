...
export default class VideoPublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:ovp:event:video-published:1-0-0', VideoPublishedV1,
      [],
      [
...
MessageResolver.register('toofab:ovp:event:video-published', VideoPublishedV1);
