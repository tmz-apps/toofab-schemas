// @link https://schemas.toofab.com/json-schema/toofab/ovp/node/video/1-0-1.json#
...
export default class VideoV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:ovp:node:video:1-0-1', VideoV1,
      [],
      [
...
MessageResolver.register('toofab:ovp:node:video', VideoV1);
