...
export default class MarkVideoAsDraftV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:ovp:command:mark-video-as-draft:1-0-0', MarkVideoAsDraftV1,
      [],
      [
...
MessageResolver.register('toofab:ovp:command:mark-video-as-draft', MarkVideoAsDraftV1);
