...
export default class GetSponsorRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:boost:request:get-sponsor-request:1-0-0', GetSponsorRequestV1,
      [],
      [
...
MessageResolver.register('toofab:boost:request:get-sponsor-request', GetSponsorRequestV1);
