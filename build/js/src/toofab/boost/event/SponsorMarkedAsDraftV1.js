...
export default class SponsorMarkedAsDraftV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:boost:event:sponsor-marked-as-draft:1-0-0', SponsorMarkedAsDraftV1,
      [],
      [
...
MessageResolver.register('toofab:boost:event:sponsor-marked-as-draft', SponsorMarkedAsDraftV1);
