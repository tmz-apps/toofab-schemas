...
export default class SponsorUpdatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:boost:event:sponsor-updated:1-0-0', SponsorUpdatedV1,
      [],
      [
...
MessageResolver.register('toofab:boost:event:sponsor-updated', SponsorUpdatedV1);
