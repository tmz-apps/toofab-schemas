...
export default class SponsorCreatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:boost:event:sponsor-created:1-0-0', SponsorCreatedV1,
      [],
      [
...
MessageResolver.register('toofab:boost:event:sponsor-created', SponsorCreatedV1);
