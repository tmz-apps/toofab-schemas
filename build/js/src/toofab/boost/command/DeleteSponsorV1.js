...
export default class DeleteSponsorV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:boost:command:delete-sponsor:1-0-0', DeleteSponsorV1,
      [],
      [
...
MessageResolver.register('toofab:boost:command:delete-sponsor', DeleteSponsorV1);
