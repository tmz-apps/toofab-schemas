...
export default class UnpublishSponsorV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:boost:command:unpublish-sponsor:1-0-0', UnpublishSponsorV1,
      [],
      [
...
MessageResolver.register('toofab:boost:command:unpublish-sponsor', UnpublishSponsorV1);
