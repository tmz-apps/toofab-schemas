...
export default class RenameSponsorV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:boost:command:rename-sponsor:1-0-0', RenameSponsorV1,
      [],
      [
...
MessageResolver.register('toofab:boost:command:rename-sponsor', RenameSponsorV1);
