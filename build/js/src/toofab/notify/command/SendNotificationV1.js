...
export default class SendNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:notify:command:send-notification:1-0-0', SendNotificationV1,
      [],
      [
...
MessageResolver.register('toofab:notify:command:send-notification', SendNotificationV1);
