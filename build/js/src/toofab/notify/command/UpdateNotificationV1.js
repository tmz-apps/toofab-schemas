...
export default class UpdateNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:notify:command:update-notification:1-0-0', UpdateNotificationV1,
      [],
      [
...
MessageResolver.register('toofab:notify:command:update-notification', UpdateNotificationV1);
