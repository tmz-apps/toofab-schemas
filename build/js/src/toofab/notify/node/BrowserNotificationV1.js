// @link https://schemas.toofab.com/json-schema/toofab/notify/node/browser-notification/1-0-0.json#
...
export default class BrowserNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:notify:node:browser-notification:1-0-0', BrowserNotificationV1,
      [],
      [
...
MessageResolver.register('toofab:notify:node:browser-notification', BrowserNotificationV1);
