// @link https://schemas.toofab.com/json-schema/toofab/notify/node/email-notification/1-0-0.json#
...
export default class EmailNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:notify:node:email-notification:1-0-0', EmailNotificationV1,
      [],
      [
...
MessageResolver.register('toofab:notify:node:email-notification', EmailNotificationV1);
