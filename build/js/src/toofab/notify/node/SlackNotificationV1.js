// @link https://schemas.toofab.com/json-schema/toofab/notify/node/slack-notification/1-0-0.json#
...
export default class SlackNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:notify:node:slack-notification:1-0-0', SlackNotificationV1,
      [],
      [
...
MessageResolver.register('toofab:notify:node:slack-notification', SlackNotificationV1);
