// @link https://schemas.toofab.com/json-schema/toofab/notify/node/ios-notification/1-0-0.json#
...
export default class IosNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:notify:node:ios-notification:1-0-0', IosNotificationV1,
      [],
      [
...
MessageResolver.register('toofab:notify:node:ios-notification', IosNotificationV1);
