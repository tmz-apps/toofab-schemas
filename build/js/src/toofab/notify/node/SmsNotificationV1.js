// @link https://schemas.toofab.com/json-schema/toofab/notify/node/sms-notification/1-0-0.json#
...
export default class SmsNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:notify:node:sms-notification:1-0-0', SmsNotificationV1,
      [],
      [
...
MessageResolver.register('toofab:notify:node:sms-notification', SmsNotificationV1);
