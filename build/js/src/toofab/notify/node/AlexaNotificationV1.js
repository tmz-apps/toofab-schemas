// @link https://schemas.toofab.com/json-schema/toofab/notify/node/alexa-notification/1-0-0.json#
...
export default class AlexaNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:notify:node:alexa-notification:1-0-0', AlexaNotificationV1,
      [],
      [
...
MessageResolver.register('toofab:notify:node:alexa-notification', AlexaNotificationV1);
