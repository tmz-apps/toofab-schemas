// @link https://schemas.toofab.com/json-schema/toofab/notify/node/twitter-notification/1-0-0.json#
...
export default class TwitterNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:notify:node:twitter-notification:1-0-0', TwitterNotificationV1,
      [],
      [
...
MessageResolver.register('toofab:notify:node:twitter-notification', TwitterNotificationV1);
