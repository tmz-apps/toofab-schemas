// @link https://schemas.toofab.com/json-schema/toofab/notify/node/android-notification/1-0-0.json#
...
export default class AndroidNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:notify:node:android-notification:1-0-0', AndroidNotificationV1,
      [],
      [
...
MessageResolver.register('toofab:notify:node:android-notification', AndroidNotificationV1);
