// @link https://schemas.toofab.com/json-schema/toofab/notify/node/apple-news-notification/1-0-0.json#
...
export default class AppleNewsNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:notify:node:apple-news-notification:1-0-0', AppleNewsNotificationV1,
      [],
      [
...
MessageResolver.register('toofab:notify:node:apple-news-notification', AppleNewsNotificationV1);
