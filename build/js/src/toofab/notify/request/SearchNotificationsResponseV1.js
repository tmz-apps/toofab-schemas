...
export default class SearchNotificationsResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:notify:request:search-notifications-response:1-0-0', SearchNotificationsResponseV1,
      [],
      [
...
MessageResolver.register('toofab:notify:request:search-notifications-response', SearchNotificationsResponseV1);
