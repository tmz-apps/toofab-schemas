...
export default class ArticleSlottingRemovedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:news:event:article-slotting-removed:1-0-0', ArticleSlottingRemovedV1,
      [],
      [
...
MessageResolver.register('toofab:news:event:article-slotting-removed', ArticleSlottingRemovedV1);
