...
export default class ArticleDeletedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:news:event:article-deleted:1-0-0', ArticleDeletedV1,
      [],
      [
...
MessageResolver.register('toofab:news:event:article-deleted', ArticleDeletedV1);
