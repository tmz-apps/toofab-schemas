...
export default class ArticleCreatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:news:event:article-created:1-0-0', ArticleCreatedV1,
      [],
      [
...
MessageResolver.register('toofab:news:event:article-created', ArticleCreatedV1);
