...
export default class ArticleUnlockedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:news:event:article-unlocked:1-0-0', ArticleUnlockedV1,
      [],
      [
...
MessageResolver.register('toofab:news:event:article-unlocked', ArticleUnlockedV1);
