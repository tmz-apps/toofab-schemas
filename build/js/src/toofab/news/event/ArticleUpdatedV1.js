...
export default class ArticleUpdatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:news:event:article-updated:1-0-0', ArticleUpdatedV1,
      [],
      [
...
MessageResolver.register('toofab:news:event:article-updated', ArticleUpdatedV1);
