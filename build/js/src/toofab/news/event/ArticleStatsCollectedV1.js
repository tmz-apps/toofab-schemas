...
export default class ArticleStatsCollectedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:news:event:article-stats-collected:1-0-0', ArticleStatsCollectedV1,
      [],
      [
...
MessageResolver.register('toofab:news:event:article-stats-collected', ArticleStatsCollectedV1);
