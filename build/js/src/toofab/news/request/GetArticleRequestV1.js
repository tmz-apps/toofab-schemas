...
export default class GetArticleRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:news:request:get-article-request:1-0-0', GetArticleRequestV1,
      [],
      [
...
MessageResolver.register('toofab:news:request:get-article-request', GetArticleRequestV1);
