...
export default class UpdateArticleV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:news:command:update-article:1-0-0', UpdateArticleV1,
      [],
      [
...
MessageResolver.register('toofab:news:command:update-article', UpdateArticleV1);
