...
export default class CreateArticleV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:news:command:create-article:1-0-0', CreateArticleV1,
      [],
      [
...
MessageResolver.register('toofab:news:command:create-article', CreateArticleV1);
