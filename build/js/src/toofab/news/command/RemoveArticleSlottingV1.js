// @link https://schemas.toofab.com/json-schema/toofab/news/command/remove-article-slotting/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:toofab:news:command:remove-article-slotting:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'toofab:news:command:remove-article-slotting';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'toofab:news:command:remove-article-slotting:v1';
