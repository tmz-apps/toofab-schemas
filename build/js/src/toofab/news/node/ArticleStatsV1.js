// @link https://schemas.toofab.com/json-schema/toofab/news/node/article-stats/1-0-0.json#
...
export default class ArticleStatsV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:news:node:article-stats:1-0-0', ArticleStatsV1,
      [],
      [
...
MessageResolver.register('toofab:news:node:article-stats', ArticleStatsV1);
