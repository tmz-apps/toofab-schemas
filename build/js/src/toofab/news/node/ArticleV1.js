// @link https://schemas.toofab.com/json-schema/toofab/news/node/article/1-0-0.json#
...
export default class ArticleV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:news:node:article:1-0-0', ArticleV1,
      [],
      [
...
MessageResolver.register('toofab:news:node:article', ArticleV1);
