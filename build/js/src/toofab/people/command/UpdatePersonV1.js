...
export default class UpdatePersonV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:people:command:update-person:1-0-0', UpdatePersonV1,
      [],
      [
...
MessageResolver.register('toofab:people:command:update-person', UpdatePersonV1);
