...
export default class PersonCreatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:people:event:person-created:1-0-0', PersonCreatedV1,
      [],
      [
...
MessageResolver.register('toofab:people:event:person-created', PersonCreatedV1);
