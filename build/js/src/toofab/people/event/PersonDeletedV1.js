...
export default class PersonDeletedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:people:event:person-deleted:1-0-0', PersonDeletedV1,
      [],
      [
...
MessageResolver.register('toofab:people:event:person-deleted', PersonDeletedV1);
