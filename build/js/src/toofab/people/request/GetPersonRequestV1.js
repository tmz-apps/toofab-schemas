...
export default class GetPersonRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:people:request:get-person-request:1-0-0', GetPersonRequestV1,
      [],
      [
...
MessageResolver.register('toofab:people:request:get-person-request', GetPersonRequestV1);
