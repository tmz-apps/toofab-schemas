...
export default class SearchPeopleResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:people:request:search-people-response:1-0-0', SearchPeopleResponseV1,
      [],
      [
...
MessageResolver.register('toofab:people:request:search-people-response', SearchPeopleResponseV1);
