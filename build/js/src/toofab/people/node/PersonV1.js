// @link https://schemas.toofab.com/json-schema/toofab/people/node/person/1-0-0.json#
...
export default class PersonV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:people:node:person:1-0-0', PersonV1,
      [],
      [
...
MessageResolver.register('toofab:people:node:person', PersonV1);
