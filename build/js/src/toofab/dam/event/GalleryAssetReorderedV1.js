...
export default class GalleryAssetReorderedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:dam:event:gallery-asset-reordered:1-0-0', GalleryAssetReorderedV1,
      [],
      [
...
MessageResolver.register('toofab:dam:event:gallery-asset-reordered', GalleryAssetReorderedV1);
