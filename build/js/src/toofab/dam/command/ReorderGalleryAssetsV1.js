...
export default class ReorderGalleryAssetsV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:toofab:dam:command:reorder-gallery-assets:1-0-0', ReorderGalleryAssetsV1,
      [],
      [
...
MessageResolver.register('toofab:dam:command:reorder-gallery-assets', ReorderGalleryAssetsV1);
