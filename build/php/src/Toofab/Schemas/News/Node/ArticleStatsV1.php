...
{
    const SCHEMA_ID = 'pbj:toofab:news:node:article-stats:1-0-0';
    const SCHEMA_CURIE = 'toofab:news:node:article-stats';
    const SCHEMA_CURIE_MAJOR = 'toofab:news:node:article-stats:v1';
    const MIXINS = [
