...
{
    const SCHEMA_ID = 'pbj:toofab:news:request:search-articles-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:news:request:search-articles-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:news:request:search-articles-request:v1';
    const MIXINS = [
