...
namespace Toofab\Schemas\News\Request;
...
{
    const SCHEMA_ID = 'pbj:toofab:news:request:get-article-history-response:1-0-0';
    const SCHEMA_CURIE = 'toofab:news:request:get-article-history-response';
    const SCHEMA_CURIE_MAJOR = 'toofab:news:request:get-article-history-response:v1';
    const MIXINS = [
