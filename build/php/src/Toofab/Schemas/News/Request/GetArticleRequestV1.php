...
{
    const SCHEMA_ID = 'pbj:toofab:news:request:get-article-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:news:request:get-article-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:news:request:get-article-request:v1';
    const MIXINS = [
