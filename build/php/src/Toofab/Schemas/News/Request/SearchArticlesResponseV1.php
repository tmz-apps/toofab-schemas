...
{
    const SCHEMA_ID = 'pbj:toofab:news:request:search-articles-response:1-0-0';
    const SCHEMA_CURIE = 'toofab:news:request:search-articles-response';
    const SCHEMA_CURIE_MAJOR = 'toofab:news:request:search-articles-response:v1';
    const MIXINS = [
