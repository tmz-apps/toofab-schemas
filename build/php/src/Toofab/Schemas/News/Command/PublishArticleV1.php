...
{
    const SCHEMA_ID = 'pbj:toofab:news:command:publish-article:1-0-0';
    const SCHEMA_CURIE = 'toofab:news:command:publish-article';
    const SCHEMA_CURIE_MAJOR = 'toofab:news:command:publish-article:v1';
    const MIXINS = [
