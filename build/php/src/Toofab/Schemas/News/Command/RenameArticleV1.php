...
{
    const SCHEMA_ID = 'pbj:toofab:news:command:rename-article:1-0-0';
    const SCHEMA_CURIE = 'toofab:news:command:rename-article';
    const SCHEMA_CURIE_MAJOR = 'toofab:news:command:rename-article:v1';
    const MIXINS = [
