...
{
    const SCHEMA_ID = 'pbj:toofab:news:command:mark-article-as-pending:1-0-0';
    const SCHEMA_CURIE = 'toofab:news:command:mark-article-as-pending';
    const SCHEMA_CURIE_MAJOR = 'toofab:news:command:mark-article-as-pending:v1';
    const MIXINS = [
