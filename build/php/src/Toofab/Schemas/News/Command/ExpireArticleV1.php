...
{
    const SCHEMA_ID = 'pbj:toofab:news:command:expire-article:1-0-0';
    const SCHEMA_CURIE = 'toofab:news:command:expire-article';
    const SCHEMA_CURIE_MAJOR = 'toofab:news:command:expire-article:v1';
    const MIXINS = [
