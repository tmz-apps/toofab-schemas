...
{
    const SCHEMA_ID = 'pbj:toofab:news:command:delete-article:1-0-0';
    const SCHEMA_CURIE = 'toofab:news:command:delete-article';
    const SCHEMA_CURIE_MAJOR = 'toofab:news:command:delete-article:v1';
    const MIXINS = [
