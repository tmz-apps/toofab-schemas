...
{
    const SCHEMA_ID = 'pbj:toofab:news:command:mark-article-as-draft:1-0-0';
    const SCHEMA_CURIE = 'toofab:news:command:mark-article-as-draft';
    const SCHEMA_CURIE_MAJOR = 'toofab:news:command:mark-article-as-draft:v1';
    const MIXINS = [
