...
{
    const SCHEMA_ID = 'pbj:toofab:news:command:collect-article-stats:1-0-0';
    const SCHEMA_CURIE = 'toofab:news:command:collect-article-stats';
    const SCHEMA_CURIE_MAJOR = 'toofab:news:command:collect-article-stats:v1';
    const MIXINS = [
