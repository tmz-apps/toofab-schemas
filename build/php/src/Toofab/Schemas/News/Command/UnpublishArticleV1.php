...
{
    const SCHEMA_ID = 'pbj:toofab:news:command:unpublish-article:1-0-0';
    const SCHEMA_CURIE = 'toofab:news:command:unpublish-article';
    const SCHEMA_CURIE_MAJOR = 'toofab:news:command:unpublish-article:v1';
    const MIXINS = [
