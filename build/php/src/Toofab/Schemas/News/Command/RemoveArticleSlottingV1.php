...
{
    const SCHEMA_ID = 'pbj:toofab:news:command:remove-article-slotting:1-0-0';
    const SCHEMA_CURIE = 'toofab:news:command:remove-article-slotting';
    const SCHEMA_CURIE_MAJOR = 'toofab:news:command:remove-article-slotting:v1';
    const MIXINS = [
