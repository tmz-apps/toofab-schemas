...
{
    const SCHEMA_ID = 'pbj:toofab:news:command:update-article:1-0-0';
    const SCHEMA_CURIE = 'toofab:news:command:update-article';
    const SCHEMA_CURIE_MAJOR = 'toofab:news:command:update-article:v1';
    const MIXINS = [
