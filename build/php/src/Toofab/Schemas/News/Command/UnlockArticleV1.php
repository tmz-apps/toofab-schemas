...
{
    const SCHEMA_ID = 'pbj:toofab:news:command:unlock-article:1-0-0';
    const SCHEMA_CURIE = 'toofab:news:command:unlock-article';
    const SCHEMA_CURIE_MAJOR = 'toofab:news:command:unlock-article:v1';
    const MIXINS = [
