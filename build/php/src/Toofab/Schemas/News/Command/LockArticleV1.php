...
{
    const SCHEMA_ID = 'pbj:toofab:news:command:lock-article:1-0-0';
    const SCHEMA_CURIE = 'toofab:news:command:lock-article';
    const SCHEMA_CURIE_MAJOR = 'toofab:news:command:lock-article:v1';
    const MIXINS = [
