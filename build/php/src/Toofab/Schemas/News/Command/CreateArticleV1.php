...
{
    const SCHEMA_ID = 'pbj:toofab:news:command:create-article:1-0-0';
    const SCHEMA_CURIE = 'toofab:news:command:create-article';
    const SCHEMA_CURIE_MAJOR = 'toofab:news:command:create-article:v1';
    const MIXINS = [
