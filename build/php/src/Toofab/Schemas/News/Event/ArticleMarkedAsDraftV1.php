...
{
    const SCHEMA_ID = 'pbj:toofab:news:event:article-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'toofab:news:event:article-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'toofab:news:event:article-marked-as-draft:v1';
    const MIXINS = [
