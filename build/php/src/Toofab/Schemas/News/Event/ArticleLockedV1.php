...
{
    const SCHEMA_ID = 'pbj:toofab:news:event:article-locked:1-0-0';
    const SCHEMA_CURIE = 'toofab:news:event:article-locked';
    const SCHEMA_CURIE_MAJOR = 'toofab:news:event:article-locked:v1';
    const MIXINS = [
