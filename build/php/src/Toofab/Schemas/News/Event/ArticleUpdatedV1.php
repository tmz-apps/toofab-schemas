...
{
    const SCHEMA_ID = 'pbj:toofab:news:event:article-updated:1-0-0';
    const SCHEMA_CURIE = 'toofab:news:event:article-updated';
    const SCHEMA_CURIE_MAJOR = 'toofab:news:event:article-updated:v1';
    const MIXINS = [
