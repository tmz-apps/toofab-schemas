...
{
    const SCHEMA_ID = 'pbj:toofab:news:event:article-renamed:1-0-0';
    const SCHEMA_CURIE = 'toofab:news:event:article-renamed';
    const SCHEMA_CURIE_MAJOR = 'toofab:news:event:article-renamed:v1';
    const MIXINS = [
