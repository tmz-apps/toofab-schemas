...
{
    const SCHEMA_ID = 'pbj:toofab:news:event:article-slotting-removed:1-0-0';
    const SCHEMA_CURIE = 'toofab:news:event:article-slotting-removed';
    const SCHEMA_CURIE_MAJOR = 'toofab:news:event:article-slotting-removed:v1';
    const MIXINS = [
