...
{
    const SCHEMA_ID = 'pbj:toofab:news:event:article-unpublished:1-0-0';
    const SCHEMA_CURIE = 'toofab:news:event:article-unpublished';
    const SCHEMA_CURIE_MAJOR = 'toofab:news:event:article-unpublished:v1';
    const MIXINS = [
