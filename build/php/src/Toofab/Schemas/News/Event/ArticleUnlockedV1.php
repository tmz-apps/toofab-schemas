...
{
    const SCHEMA_ID = 'pbj:toofab:news:event:article-unlocked:1-0-0';
    const SCHEMA_CURIE = 'toofab:news:event:article-unlocked';
    const SCHEMA_CURIE_MAJOR = 'toofab:news:event:article-unlocked:v1';
    const MIXINS = [
