...
{
    const SCHEMA_ID = 'pbj:toofab:news:event:apple-news-article-synced:1-0-0';
    const SCHEMA_CURIE = 'toofab:news:event:apple-news-article-synced';
    const SCHEMA_CURIE_MAJOR = 'toofab:news:event:apple-news-article-synced:v1';
    const MIXINS = [
