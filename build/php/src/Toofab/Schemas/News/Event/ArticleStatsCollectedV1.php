...
{
    const SCHEMA_ID = 'pbj:toofab:news:event:article-stats-collected:1-0-0';
    const SCHEMA_CURIE = 'toofab:news:event:article-stats-collected';
    const SCHEMA_CURIE_MAJOR = 'toofab:news:event:article-stats-collected:v1';
    const MIXINS = [
