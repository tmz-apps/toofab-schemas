...
{
    const SCHEMA_ID = 'pbj:toofab:news:event:article-scheduled:1-0-0';
    const SCHEMA_CURIE = 'toofab:news:event:article-scheduled';
    const SCHEMA_CURIE_MAJOR = 'toofab:news:event:article-scheduled:v1';
    const MIXINS = [
