...
{
    const SCHEMA_ID = 'pbj:toofab:news:event:article-expired:1-0-0';
    const SCHEMA_CURIE = 'toofab:news:event:article-expired';
    const SCHEMA_CURIE_MAJOR = 'toofab:news:event:article-expired:v1';
    const MIXINS = [
