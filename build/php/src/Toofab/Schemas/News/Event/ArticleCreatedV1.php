...
{
    const SCHEMA_ID = 'pbj:toofab:news:event:article-created:1-0-0';
    const SCHEMA_CURIE = 'toofab:news:event:article-created';
    const SCHEMA_CURIE_MAJOR = 'toofab:news:event:article-created:v1';
    const MIXINS = [
