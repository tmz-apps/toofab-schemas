...
namespace Toofab\Schemas\News\Event;
...
{
    const SCHEMA_ID = 'pbj:toofab:news:event:article-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'toofab:news:event:article-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'toofab:news:event:article-marked-as-pending:v1';
    const MIXINS = [
