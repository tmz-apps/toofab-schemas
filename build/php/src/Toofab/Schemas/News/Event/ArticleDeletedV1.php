...
{
    const SCHEMA_ID = 'pbj:toofab:news:event:article-deleted:1-0-0';
    const SCHEMA_CURIE = 'toofab:news:event:article-deleted';
    const SCHEMA_CURIE_MAJOR = 'toofab:news:event:article-deleted:v1';
    const MIXINS = [
