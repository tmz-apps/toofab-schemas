...
{
    const SCHEMA_ID = 'pbj:toofab:news:event:article-published:1-0-0';
    const SCHEMA_CURIE = 'toofab:news:event:article-published';
    const SCHEMA_CURIE_MAJOR = 'toofab:news:event:article-published:v1';
    const MIXINS = [
