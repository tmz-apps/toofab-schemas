...
{
    const SCHEMA_ID = 'pbj:toofab:dam:request:search-assets-response:1-0-0';
    const SCHEMA_CURIE = 'toofab:dam:request:search-assets-response';
    const SCHEMA_CURIE_MAJOR = 'toofab:dam:request:search-assets-response:v1';
    const MIXINS = [
