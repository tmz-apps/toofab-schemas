...
{
    const SCHEMA_ID = 'pbj:toofab:dam:request:get-asset-response:1-0-0';
    const SCHEMA_CURIE = 'toofab:dam:request:get-asset-response';
    const SCHEMA_CURIE_MAJOR = 'toofab:dam:request:get-asset-response:v1';
    const MIXINS = [
