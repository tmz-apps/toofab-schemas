...
{
    const SCHEMA_ID = 'pbj:toofab:dam:request:search-assets-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:dam:request:search-assets-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:dam:request:search-assets-request:v1';
    const MIXINS = [
