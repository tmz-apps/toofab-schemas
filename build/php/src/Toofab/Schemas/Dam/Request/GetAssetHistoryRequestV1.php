...
{
    const SCHEMA_ID = 'pbj:toofab:dam:request:get-asset-history-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:dam:request:get-asset-history-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:dam:request:get-asset-history-request:v1';
    const MIXINS = [
