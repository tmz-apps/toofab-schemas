...
{
    const SCHEMA_ID = 'pbj:toofab:dam:command:unlink-assets:1-0-0';
    const SCHEMA_CURIE = 'toofab:dam:command:unlink-assets';
    const SCHEMA_CURIE_MAJOR = 'toofab:dam:command:unlink-assets:v1';
    const MIXINS = [
