...
{
    const SCHEMA_ID = 'pbj:toofab:dam:command:delete-asset:1-0-0';
    const SCHEMA_CURIE = 'toofab:dam:command:delete-asset';
    const SCHEMA_CURIE_MAJOR = 'toofab:dam:command:delete-asset:v1';
    const MIXINS = [
