...
{
    const SCHEMA_ID = 'pbj:toofab:dam:command:link-assets:1-0-0';
    const SCHEMA_CURIE = 'toofab:dam:command:link-assets';
    const SCHEMA_CURIE_MAJOR = 'toofab:dam:command:link-assets:v1';
    const MIXINS = [
