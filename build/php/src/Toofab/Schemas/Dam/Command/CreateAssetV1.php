...
{
    const SCHEMA_ID = 'pbj:toofab:dam:command:create-asset:1-0-0';
    const SCHEMA_CURIE = 'toofab:dam:command:create-asset';
    const SCHEMA_CURIE_MAJOR = 'toofab:dam:command:create-asset:v1';
    const MIXINS = [
