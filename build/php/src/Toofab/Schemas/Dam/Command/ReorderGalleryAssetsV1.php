...
namespace Toofab\Schemas\Dam\Command;
...
{
    const SCHEMA_ID = 'pbj:toofab:dam:command:reorder-gallery-assets:1-0-0';
    const SCHEMA_CURIE = 'toofab:dam:command:reorder-gallery-assets';
    const SCHEMA_CURIE_MAJOR = 'toofab:dam:command:reorder-gallery-assets:v1';
    const MIXINS = [
