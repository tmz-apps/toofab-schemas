...
{
    const SCHEMA_ID = 'pbj:toofab:dam:command:update-asset:1-0-0';
    const SCHEMA_CURIE = 'toofab:dam:command:update-asset';
    const SCHEMA_CURIE_MAJOR = 'toofab:dam:command:update-asset:v1';
    const MIXINS = [
