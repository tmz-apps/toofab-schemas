...
{
    const SCHEMA_ID = 'pbj:toofab:dam:command:expire-asset:1-0-0';
    const SCHEMA_CURIE = 'toofab:dam:command:expire-asset';
    const SCHEMA_CURIE_MAJOR = 'toofab:dam:command:expire-asset:v1';
    const MIXINS = [
