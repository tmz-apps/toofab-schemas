...
{
    const SCHEMA_ID = 'pbj:toofab:dam:command:patch-assets:1-0-0';
    const SCHEMA_CURIE = 'toofab:dam:command:patch-assets';
    const SCHEMA_CURIE_MAJOR = 'toofab:dam:command:patch-assets:v1';
    const MIXINS = [
