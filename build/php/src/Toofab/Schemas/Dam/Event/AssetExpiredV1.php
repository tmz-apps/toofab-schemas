...
{
    const SCHEMA_ID = 'pbj:toofab:dam:event:asset-expired:1-0-0';
    const SCHEMA_CURIE = 'toofab:dam:event:asset-expired';
    const SCHEMA_CURIE_MAJOR = 'toofab:dam:event:asset-expired:v1';
    const MIXINS = [
