...
namespace Toofab\Schemas\Dam\Event;
...
{
    const SCHEMA_ID = 'pbj:toofab:dam:event:gallery-asset-reordered:1-0-0';
    const SCHEMA_CURIE = 'toofab:dam:event:gallery-asset-reordered';
    const SCHEMA_CURIE_MAJOR = 'toofab:dam:event:gallery-asset-reordered:v1';
    const MIXINS = [
