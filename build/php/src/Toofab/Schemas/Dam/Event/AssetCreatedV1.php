...
{
    const SCHEMA_ID = 'pbj:toofab:dam:event:asset-created:1-0-0';
    const SCHEMA_CURIE = 'toofab:dam:event:asset-created';
    const SCHEMA_CURIE_MAJOR = 'toofab:dam:event:asset-created:v1';
    const MIXINS = [
