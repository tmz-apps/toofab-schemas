...
{
    const SCHEMA_ID = 'pbj:toofab:dam:event:asset-deleted:1-0-0';
    const SCHEMA_CURIE = 'toofab:dam:event:asset-deleted';
    const SCHEMA_CURIE_MAJOR = 'toofab:dam:event:asset-deleted:v1';
    const MIXINS = [
