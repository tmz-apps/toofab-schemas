...
{
    const SCHEMA_ID = 'pbj:toofab:dam:event:asset-linked:1-0-0';
    const SCHEMA_CURIE = 'toofab:dam:event:asset-linked';
    const SCHEMA_CURIE_MAJOR = 'toofab:dam:event:asset-linked:v1';
    const MIXINS = [
