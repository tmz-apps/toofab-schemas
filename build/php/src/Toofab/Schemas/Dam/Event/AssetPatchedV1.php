...
{
    const SCHEMA_ID = 'pbj:toofab:dam:event:asset-patched:1-0-0';
    const SCHEMA_CURIE = 'toofab:dam:event:asset-patched';
    const SCHEMA_CURIE_MAJOR = 'toofab:dam:event:asset-patched:v1';
    const MIXINS = [
