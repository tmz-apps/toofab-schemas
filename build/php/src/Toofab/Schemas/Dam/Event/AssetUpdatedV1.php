...
{
    const SCHEMA_ID = 'pbj:toofab:dam:event:asset-updated:1-0-0';
    const SCHEMA_CURIE = 'toofab:dam:event:asset-updated';
    const SCHEMA_CURIE_MAJOR = 'toofab:dam:event:asset-updated:v1';
    const MIXINS = [
