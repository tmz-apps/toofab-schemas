...
{
    const SCHEMA_ID = 'pbj:toofab:dam:event:asset-unlinked:1-0-0';
    const SCHEMA_CURIE = 'toofab:dam:event:asset-unlinked';
    const SCHEMA_CURIE_MAJOR = 'toofab:dam:event:asset-unlinked:v1';
    const MIXINS = [
