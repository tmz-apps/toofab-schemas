...
{
    const SCHEMA_ID = 'pbj:toofab:dam:node:code-asset:1-0-0';
    const SCHEMA_CURIE = 'toofab:dam:node:code-asset';
    const SCHEMA_CURIE_MAJOR = 'toofab:dam:node:code-asset:v1';
    const MIXINS = [
