...
namespace Toofab\Schemas\Dam\Node;
...
{
    const SCHEMA_ID = 'pbj:toofab:dam:node:document-asset:1-0-0';
    const SCHEMA_CURIE = 'toofab:dam:node:document-asset';
    const SCHEMA_CURIE_MAJOR = 'toofab:dam:node:document-asset:v1';
    const MIXINS = [
