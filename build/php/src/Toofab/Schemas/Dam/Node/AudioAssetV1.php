...
{
    const SCHEMA_ID = 'pbj:toofab:dam:node:audio-asset:1-0-0';
    const SCHEMA_CURIE = 'toofab:dam:node:audio-asset';
    const SCHEMA_CURIE_MAJOR = 'toofab:dam:node:audio-asset:v1';
    const MIXINS = [
