...
{
    const SCHEMA_ID = 'pbj:toofab:dam:node:archive-asset:1-0-0';
    const SCHEMA_CURIE = 'toofab:dam:node:archive-asset';
    const SCHEMA_CURIE_MAJOR = 'toofab:dam:node:archive-asset:v1';
    const MIXINS = [
