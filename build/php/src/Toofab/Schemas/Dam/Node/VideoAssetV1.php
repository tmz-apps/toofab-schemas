...
{
    const SCHEMA_ID = 'pbj:toofab:dam:node:video-asset:1-0-0';
    const SCHEMA_CURIE = 'toofab:dam:node:video-asset';
    const SCHEMA_CURIE_MAJOR = 'toofab:dam:node:video-asset:v1';
    const MIXINS = [
