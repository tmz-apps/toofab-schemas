...
{
    const SCHEMA_ID = 'pbj:toofab:dam:node:unknown-asset:1-0-0';
    const SCHEMA_CURIE = 'toofab:dam:node:unknown-asset';
    const SCHEMA_CURIE_MAJOR = 'toofab:dam:node:unknown-asset:v1';
    const MIXINS = [
