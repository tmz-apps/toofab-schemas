...
{
    const SCHEMA_ID = 'pbj:toofab:dam:node:image-asset:1-0-0';
    const SCHEMA_CURIE = 'toofab:dam:node:image-asset';
    const SCHEMA_CURIE_MAJOR = 'toofab:dam:node:image-asset:v1';
    const MIXINS = [
