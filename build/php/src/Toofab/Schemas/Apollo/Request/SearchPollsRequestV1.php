...
{
    const SCHEMA_ID = 'pbj:toofab:apollo:request:search-polls-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:apollo:request:search-polls-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:apollo:request:search-polls-request:v1';
    const MIXINS = [
