...
namespace Toofab\Schemas\Apollo\Request;
...
{
    const SCHEMA_ID = 'pbj:toofab:apollo:request:get-poll-history-response:1-0-0';
    const SCHEMA_CURIE = 'toofab:apollo:request:get-poll-history-response';
    const SCHEMA_CURIE_MAJOR = 'toofab:apollo:request:get-poll-history-response:v1';
    const MIXINS = [
