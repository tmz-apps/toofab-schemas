...
{
    const SCHEMA_ID = 'pbj:toofab:apollo:request:get-poll-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:apollo:request:get-poll-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:apollo:request:get-poll-request:v1';
    const MIXINS = [
