...
{
    const SCHEMA_ID = 'pbj:toofab:apollo:request:search-polls-response:1-0-0';
    const SCHEMA_CURIE = 'toofab:apollo:request:search-polls-response';
    const SCHEMA_CURIE_MAJOR = 'toofab:apollo:request:search-polls-response:v1';
    const MIXINS = [
