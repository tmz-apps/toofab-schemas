...
{
    const SCHEMA_ID = 'pbj:toofab:apollo:request:get-poll-history-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:apollo:request:get-poll-history-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:apollo:request:get-poll-history-request:v1';
    const MIXINS = [
