...
{
    const SCHEMA_ID = 'pbj:toofab:apollo:event:poll-expired:1-0-0';
    const SCHEMA_CURIE = 'toofab:apollo:event:poll-expired';
    const SCHEMA_CURIE_MAJOR = 'toofab:apollo:event:poll-expired:v1';
    const MIXINS = [
