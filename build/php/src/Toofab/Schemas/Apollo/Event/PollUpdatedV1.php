...
{
    const SCHEMA_ID = 'pbj:toofab:apollo:event:poll-updated:1-0-0';
    const SCHEMA_CURIE = 'toofab:apollo:event:poll-updated';
    const SCHEMA_CURIE_MAJOR = 'toofab:apollo:event:poll-updated:v1';
    const MIXINS = [
