...
{
    const SCHEMA_ID = 'pbj:toofab:apollo:event:poll-unpublished:1-0-0';
    const SCHEMA_CURIE = 'toofab:apollo:event:poll-unpublished';
    const SCHEMA_CURIE_MAJOR = 'toofab:apollo:event:poll-unpublished:v1';
    const MIXINS = [
