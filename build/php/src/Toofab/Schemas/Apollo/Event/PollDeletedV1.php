...
{
    const SCHEMA_ID = 'pbj:toofab:apollo:event:poll-deleted:1-0-0';
    const SCHEMA_CURIE = 'toofab:apollo:event:poll-deleted';
    const SCHEMA_CURIE_MAJOR = 'toofab:apollo:event:poll-deleted:v1';
    const MIXINS = [
