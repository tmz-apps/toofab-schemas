...
{
    const SCHEMA_ID = 'pbj:toofab:apollo:event:poll-published:1-0-0';
    const SCHEMA_CURIE = 'toofab:apollo:event:poll-published';
    const SCHEMA_CURIE_MAJOR = 'toofab:apollo:event:poll-published:v1';
    const MIXINS = [
