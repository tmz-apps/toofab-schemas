...
{
    const SCHEMA_ID = 'pbj:toofab:apollo:event:vote-casted:1-0-0';
    const SCHEMA_CURIE = 'toofab:apollo:event:vote-casted';
    const SCHEMA_CURIE_MAJOR = 'toofab:apollo:event:vote-casted:v1';
    const MIXINS = [
