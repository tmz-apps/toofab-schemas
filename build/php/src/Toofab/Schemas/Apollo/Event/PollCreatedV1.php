...
{
    const SCHEMA_ID = 'pbj:toofab:apollo:event:poll-created:1-0-0';
    const SCHEMA_CURIE = 'toofab:apollo:event:poll-created';
    const SCHEMA_CURIE_MAJOR = 'toofab:apollo:event:poll-created:v1';
    const MIXINS = [
