...
{
    const SCHEMA_ID = 'pbj:toofab:apollo:event:poll-scheduled:1-0-0';
    const SCHEMA_CURIE = 'toofab:apollo:event:poll-scheduled';
    const SCHEMA_CURIE_MAJOR = 'toofab:apollo:event:poll-scheduled:v1';
    const MIXINS = [
