...
{
    const SCHEMA_ID = 'pbj:toofab:apollo:command:delete-poll:1-0-0';
    const SCHEMA_CURIE = 'toofab:apollo:command:delete-poll';
    const SCHEMA_CURIE_MAJOR = 'toofab:apollo:command:delete-poll:v1';
    const MIXINS = [
