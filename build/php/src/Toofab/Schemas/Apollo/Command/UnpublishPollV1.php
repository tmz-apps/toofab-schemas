...
{
    const SCHEMA_ID = 'pbj:toofab:apollo:command:unpublish-poll:1-0-0';
    const SCHEMA_CURIE = 'toofab:apollo:command:unpublish-poll';
    const SCHEMA_CURIE_MAJOR = 'toofab:apollo:command:unpublish-poll:v1';
    const MIXINS = [
