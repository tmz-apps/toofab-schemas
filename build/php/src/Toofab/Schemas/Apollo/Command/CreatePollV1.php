...
{
    const SCHEMA_ID = 'pbj:toofab:apollo:command:create-poll:1-0-0';
    const SCHEMA_CURIE = 'toofab:apollo:command:create-poll';
    const SCHEMA_CURIE_MAJOR = 'toofab:apollo:command:create-poll:v1';
    const MIXINS = [
