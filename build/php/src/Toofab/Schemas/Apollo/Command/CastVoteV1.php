...
{
    const SCHEMA_ID = 'pbj:toofab:apollo:command:cast-vote:1-0-0';
    const SCHEMA_CURIE = 'toofab:apollo:command:cast-vote';
    const SCHEMA_CURIE_MAJOR = 'toofab:apollo:command:cast-vote:v1';
    const MIXINS = [
