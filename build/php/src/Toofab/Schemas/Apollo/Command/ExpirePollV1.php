...
{
    const SCHEMA_ID = 'pbj:toofab:apollo:command:expire-poll:1-0-0';
    const SCHEMA_CURIE = 'toofab:apollo:command:expire-poll';
    const SCHEMA_CURIE_MAJOR = 'toofab:apollo:command:expire-poll:v1';
    const MIXINS = [
