...
{
    const SCHEMA_ID = 'pbj:toofab:apollo:command:update-poll:1-0-0';
    const SCHEMA_CURIE = 'toofab:apollo:command:update-poll';
    const SCHEMA_CURIE_MAJOR = 'toofab:apollo:command:update-poll:v1';
    const MIXINS = [
