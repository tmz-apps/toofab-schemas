...
{
    const SCHEMA_ID = 'pbj:toofab:apollo:command:publish-poll:1-0-0';
    const SCHEMA_CURIE = 'toofab:apollo:command:publish-poll';
    const SCHEMA_CURIE_MAJOR = 'toofab:apollo:command:publish-poll:v1';
    const MIXINS = [
