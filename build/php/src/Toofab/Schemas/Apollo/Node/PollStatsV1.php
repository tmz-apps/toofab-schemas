...
{
    const SCHEMA_ID = 'pbj:toofab:apollo:node:poll-stats:1-0-0';
    const SCHEMA_CURIE = 'toofab:apollo:node:poll-stats';
    const SCHEMA_CURIE_MAJOR = 'toofab:apollo:node:poll-stats:v1';
    const MIXINS = [
