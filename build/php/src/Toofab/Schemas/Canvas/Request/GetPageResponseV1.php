...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:request:get-page-response:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:request:get-page-response';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:request:get-page-response:v1';
    const MIXINS = [
