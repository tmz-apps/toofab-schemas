...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:request:get-page-history-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:request:get-page-history-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:request:get-page-history-request:v1';
    const MIXINS = [
