...
namespace Toofab\Schemas\Canvas\Request;
...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:request:get-page-history-response:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:request:get-page-history-response';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:request:get-page-history-response:v1';
    const MIXINS = [
