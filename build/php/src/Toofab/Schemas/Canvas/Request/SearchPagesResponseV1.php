...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:request:search-pages-response:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:request:search-pages-response';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:request:search-pages-response:v1';
    const MIXINS = [
