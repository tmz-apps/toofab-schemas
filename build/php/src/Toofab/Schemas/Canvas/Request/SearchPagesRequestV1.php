...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:request:search-pages-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:request:search-pages-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:request:search-pages-request:v1';
    const MIXINS = [
