...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:request:get-page-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:request:get-page-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:request:get-page-request:v1';
    const MIXINS = [
