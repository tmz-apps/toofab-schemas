...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:command:expire-page:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:command:expire-page';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:command:expire-page:v1';
    const MIXINS = [
