...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:command:unpublish-page:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:command:unpublish-page';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:command:unpublish-page:v1';
    const MIXINS = [
