...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:command:publish-page:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:command:publish-page';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:command:publish-page:v1';
    const MIXINS = [
