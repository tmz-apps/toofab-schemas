...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:command:update-page:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:command:update-page';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:command:update-page:v1';
    const MIXINS = [
