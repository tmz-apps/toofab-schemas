...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:command:rename-page:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:command:rename-page';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:command:rename-page:v1';
    const MIXINS = [
