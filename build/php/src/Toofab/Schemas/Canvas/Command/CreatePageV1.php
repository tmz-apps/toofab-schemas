...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:command:create-page:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:command:create-page';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:command:create-page:v1';
    const MIXINS = [
