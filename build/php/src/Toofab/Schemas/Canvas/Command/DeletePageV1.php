...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:command:delete-page:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:command:delete-page';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:command:delete-page:v1';
    const MIXINS = [
