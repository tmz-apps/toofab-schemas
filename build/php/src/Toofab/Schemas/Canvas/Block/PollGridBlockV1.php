...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:block:poll-grid-block:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:block:poll-grid-block';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:block:poll-grid-block:v1';
    const MIXINS = [
