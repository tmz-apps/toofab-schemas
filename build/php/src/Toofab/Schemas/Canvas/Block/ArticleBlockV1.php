...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:block:article-block:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:block:article-block';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:block:article-block:v1';
    const MIXINS = [
