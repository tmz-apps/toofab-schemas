...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:block:image-block:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:block:image-block';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:block:image-block:v1';
    const MIXINS = [
