...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:block:audio-block:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:block:audio-block';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:block:audio-block:v1';
    const MIXINS = [
