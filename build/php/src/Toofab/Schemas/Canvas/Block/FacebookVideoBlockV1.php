...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:block:facebook-video-block:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:block:facebook-video-block';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:block:facebook-video-block:v1';
    const MIXINS = [
