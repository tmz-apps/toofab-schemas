...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:block:code-block:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:block:code-block';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:block:code-block:v1';
    const MIXINS = [
