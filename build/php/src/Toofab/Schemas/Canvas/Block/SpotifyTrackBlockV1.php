...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:block:spotify-track-block:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:block:spotify-track-block';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:block:spotify-track-block:v1';
    const MIXINS = [
