...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:block:heading-block:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:block:heading-block';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:block:heading-block:v1';
    const MIXINS = [
