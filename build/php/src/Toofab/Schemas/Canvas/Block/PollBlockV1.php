...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:block:poll-block:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:block:poll-block';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:block:poll-block:v1';
    const MIXINS = [
