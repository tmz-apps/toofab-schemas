...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:block:quote-block:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:block:quote-block';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:block:quote-block:v1';
    const MIXINS = [
