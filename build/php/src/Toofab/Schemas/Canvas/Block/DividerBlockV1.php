...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:block:divider-block:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:block:divider-block';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:block:divider-block:v1';
    const MIXINS = [
