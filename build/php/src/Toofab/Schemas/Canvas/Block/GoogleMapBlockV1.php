...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:block:google-map-block:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:block:google-map-block';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:block:google-map-block:v1';
    const MIXINS = [
