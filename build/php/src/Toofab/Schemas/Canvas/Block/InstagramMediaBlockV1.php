...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:block:instagram-media-block:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:block:instagram-media-block';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:block:instagram-media-block:v1';
    const MIXINS = [
