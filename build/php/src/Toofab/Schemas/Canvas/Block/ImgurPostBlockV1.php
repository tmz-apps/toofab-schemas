...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:block:imgur-post-block:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:block:imgur-post-block';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:block:imgur-post-block:v1';
    const MIXINS = [
