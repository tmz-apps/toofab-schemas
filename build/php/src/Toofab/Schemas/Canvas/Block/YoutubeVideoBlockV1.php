...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:block:youtube-video-block:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:block:youtube-video-block';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:block:youtube-video-block:v1';
    const MIXINS = [
