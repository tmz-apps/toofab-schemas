...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:block:gallery-block:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:block:gallery-block';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:block:gallery-block:v1';
    const MIXINS = [
