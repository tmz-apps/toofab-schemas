...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:block:iframe-block:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:block:iframe-block';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:block:iframe-block:v1';
    const MIXINS = [
