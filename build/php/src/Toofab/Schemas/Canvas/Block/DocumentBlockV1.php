...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:block:document-block:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:block:document-block';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:block:document-block:v1';
    const MIXINS = [
