...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:block:facebook-post-block:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:block:facebook-post-block';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:block:facebook-post-block:v1';
    const MIXINS = [
