...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:event:page-created:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:event:page-created';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:event:page-created:v1';
    const MIXINS = [
