...
namespace Toofab\Schemas\Canvas\Event;
...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:event:page-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:event:page-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:event:page-marked-as-pending:v1';
    const MIXINS = [
