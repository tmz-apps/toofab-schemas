...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:event:page-renamed:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:event:page-renamed';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:event:page-renamed:v1';
    const MIXINS = [
