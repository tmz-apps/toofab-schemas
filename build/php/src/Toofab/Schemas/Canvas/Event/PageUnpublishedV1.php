...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:event:page-unpublished:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:event:page-unpublished';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:event:page-unpublished:v1';
    const MIXINS = [
