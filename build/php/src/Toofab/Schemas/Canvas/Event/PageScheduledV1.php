...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:event:page-scheduled:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:event:page-scheduled';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:event:page-scheduled:v1';
    const MIXINS = [
