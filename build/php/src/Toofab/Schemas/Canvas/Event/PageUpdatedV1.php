...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:event:page-updated:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:event:page-updated';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:event:page-updated:v1';
    const MIXINS = [
