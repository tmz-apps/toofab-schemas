...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:event:page-published:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:event:page-published';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:event:page-published:v1';
    const MIXINS = [
