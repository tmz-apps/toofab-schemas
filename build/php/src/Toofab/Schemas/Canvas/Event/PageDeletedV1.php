...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:event:page-deleted:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:event:page-deleted';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:event:page-deleted:v1';
    const MIXINS = [
