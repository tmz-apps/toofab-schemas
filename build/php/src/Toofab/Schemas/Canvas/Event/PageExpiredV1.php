...
{
    const SCHEMA_ID = 'pbj:toofab:canvas:event:page-expired:1-0-0';
    const SCHEMA_CURIE = 'toofab:canvas:event:page-expired';
    const SCHEMA_CURIE_MAJOR = 'toofab:canvas:event:page-expired:v1';
    const MIXINS = [
