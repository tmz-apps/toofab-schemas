...
{
    const SCHEMA_ID = 'pbj:toofab:iam:command:delete-user:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:command:delete-user';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:command:delete-user:v1';
    const MIXINS = [
