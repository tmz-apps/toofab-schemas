...
{
    const SCHEMA_ID = 'pbj:toofab:iam:command:create-app:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:command:create-app';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:command:create-app:v1';
    const MIXINS = [
