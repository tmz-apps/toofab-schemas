...
{
    const SCHEMA_ID = 'pbj:toofab:iam:command:update-user:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:command:update-user';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:command:update-user:v1';
    const MIXINS = [
