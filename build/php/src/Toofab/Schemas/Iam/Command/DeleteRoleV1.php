...
{
    const SCHEMA_ID = 'pbj:toofab:iam:command:delete-role:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:command:delete-role';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:command:delete-role:v1';
    const MIXINS = [
