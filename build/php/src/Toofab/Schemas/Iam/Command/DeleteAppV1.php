...
{
    const SCHEMA_ID = 'pbj:toofab:iam:command:delete-app:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:command:delete-app';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:command:delete-app:v1';
    const MIXINS = [
