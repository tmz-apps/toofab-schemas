...
{
    const SCHEMA_ID = 'pbj:toofab:iam:command:update-app:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:command:update-app';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:command:update-app:v1';
    const MIXINS = [
