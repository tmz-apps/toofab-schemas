...
{
    const SCHEMA_ID = 'pbj:toofab:iam:command:create-role:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:command:create-role';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:command:create-role:v1';
    const MIXINS = [
