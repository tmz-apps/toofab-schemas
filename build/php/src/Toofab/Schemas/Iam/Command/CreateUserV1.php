...
{
    const SCHEMA_ID = 'pbj:toofab:iam:command:create-user:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:command:create-user';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:command:create-user:v1';
    const MIXINS = [
