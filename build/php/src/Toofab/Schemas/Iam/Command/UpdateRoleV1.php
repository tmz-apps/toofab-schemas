...
{
    const SCHEMA_ID = 'pbj:toofab:iam:command:update-role:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:command:update-role';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:command:update-role:v1';
    const MIXINS = [
