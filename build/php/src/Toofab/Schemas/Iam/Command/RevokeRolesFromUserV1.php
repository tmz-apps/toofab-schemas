...
namespace Toofab\Schemas\Iam\Command;
...
{
    const SCHEMA_ID = 'pbj:toofab:iam:command:revoke-roles-from-user:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:command:revoke-roles-from-user';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:command:revoke-roles-from-user:v1';
    const MIXINS = [
