...
{
    const SCHEMA_ID = 'pbj:toofab:iam:request:list-all-roles-response:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:request:list-all-roles-response';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:request:list-all-roles-response:v1';
    const MIXINS = [
