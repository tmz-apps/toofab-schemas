...
{
    const SCHEMA_ID = 'pbj:toofab:iam:request:get-role-history-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:request:get-role-history-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:request:get-role-history-request:v1';
    const MIXINS = [
