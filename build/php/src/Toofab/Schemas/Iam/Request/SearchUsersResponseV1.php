...
{
    const SCHEMA_ID = 'pbj:toofab:iam:request:search-users-response:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:request:search-users-response';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:request:search-users-response:v1';
    const MIXINS = [
