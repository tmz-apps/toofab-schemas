...
{
    const SCHEMA_ID = 'pbj:toofab:iam:request:get-app-response:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:request:get-app-response';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:request:get-app-response:v1';
    const MIXINS = [
