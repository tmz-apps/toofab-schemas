...
{
    const SCHEMA_ID = 'pbj:toofab:iam:request:get-user-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:request:get-user-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:request:get-user-request:v1';
    const MIXINS = [
