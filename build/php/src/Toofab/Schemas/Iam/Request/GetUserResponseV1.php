...
{
    const SCHEMA_ID = 'pbj:toofab:iam:request:get-user-response:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:request:get-user-response';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:request:get-user-response:v1';
    const MIXINS = [
