...
{
    const SCHEMA_ID = 'pbj:toofab:iam:request:search-users-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:request:search-users-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:request:search-users-request:v1';
    const MIXINS = [
