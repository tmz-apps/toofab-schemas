...
{
    const SCHEMA_ID = 'pbj:toofab:iam:request:list-all-roles-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:request:list-all-roles-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:request:list-all-roles-request:v1';
    const MIXINS = [
