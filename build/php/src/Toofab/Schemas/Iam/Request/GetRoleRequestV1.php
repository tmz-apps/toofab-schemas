...
{
    const SCHEMA_ID = 'pbj:toofab:iam:request:get-role-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:request:get-role-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:request:get-role-request:v1';
    const MIXINS = [
