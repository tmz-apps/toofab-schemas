...
{
    const SCHEMA_ID = 'pbj:toofab:iam:event:user-created:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:event:user-created';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:event:user-created:v1';
    const MIXINS = [
