...
{
    const SCHEMA_ID = 'pbj:toofab:iam:event:user-roles-revoked:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:event:user-roles-revoked';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:event:user-roles-revoked:v1';
    const MIXINS = [
