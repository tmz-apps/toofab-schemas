...
{
    const SCHEMA_ID = 'pbj:toofab:iam:event:app-roles-revoked:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:event:app-roles-revoked';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:event:app-roles-revoked:v1';
    const MIXINS = [
