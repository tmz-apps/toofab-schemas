...
{
    const SCHEMA_ID = 'pbj:toofab:iam:event:user-deleted:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:event:user-deleted';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:event:user-deleted:v1';
    const MIXINS = [
