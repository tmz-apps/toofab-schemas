...
{
    const SCHEMA_ID = 'pbj:toofab:iam:event:app-roles-granted:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:event:app-roles-granted';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:event:app-roles-granted:v1';
    const MIXINS = [
