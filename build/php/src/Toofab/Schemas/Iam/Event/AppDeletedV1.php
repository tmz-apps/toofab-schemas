...
{
    const SCHEMA_ID = 'pbj:toofab:iam:event:app-deleted:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:event:app-deleted';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:event:app-deleted:v1';
    const MIXINS = [
