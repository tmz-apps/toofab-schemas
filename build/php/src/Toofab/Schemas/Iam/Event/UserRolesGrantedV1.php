...
namespace Toofab\Schemas\Iam\Event;
...
{
    const SCHEMA_ID = 'pbj:toofab:iam:event:user-roles-granted:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:event:user-roles-granted';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:event:user-roles-granted:v1';
    const MIXINS = [
