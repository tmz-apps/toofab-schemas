...
{
    const SCHEMA_ID = 'pbj:toofab:iam:event:role-updated:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:event:role-updated';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:event:role-updated:v1';
    const MIXINS = [
