...
{
    const SCHEMA_ID = 'pbj:toofab:iam:event:role-deleted:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:event:role-deleted';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:event:role-deleted:v1';
    const MIXINS = [
