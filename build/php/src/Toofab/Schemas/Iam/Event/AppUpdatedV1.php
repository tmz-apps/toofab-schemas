...
{
    const SCHEMA_ID = 'pbj:toofab:iam:event:app-updated:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:event:app-updated';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:event:app-updated:v1';
    const MIXINS = [
