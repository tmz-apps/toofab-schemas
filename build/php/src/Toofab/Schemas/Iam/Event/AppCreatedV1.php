...
{
    const SCHEMA_ID = 'pbj:toofab:iam:event:app-created:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:event:app-created';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:event:app-created:v1';
    const MIXINS = [
