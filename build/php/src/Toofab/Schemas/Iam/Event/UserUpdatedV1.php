...
{
    const SCHEMA_ID = 'pbj:toofab:iam:event:user-updated:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:event:user-updated';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:event:user-updated:v1';
    const MIXINS = [
