...
{
    const SCHEMA_ID = 'pbj:toofab:iam:event:role-created:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:event:role-created';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:event:role-created:v1';
    const MIXINS = [
