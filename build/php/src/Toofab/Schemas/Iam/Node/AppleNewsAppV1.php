...
{
    const SCHEMA_ID = 'pbj:toofab:iam:node:apple-news-app:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:node:apple-news-app';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:node:apple-news-app:v1';
    const MIXINS = [
