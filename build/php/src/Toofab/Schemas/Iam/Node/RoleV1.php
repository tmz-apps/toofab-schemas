...
namespace Toofab\Schemas\Iam\Node;
...
{
    const SCHEMA_ID = 'pbj:toofab:iam:node:role:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:node:role';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:node:role:v1';
    const MIXINS = [
