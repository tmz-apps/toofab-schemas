...
{
    const SCHEMA_ID = 'pbj:toofab:iam:node:browser-app:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:node:browser-app';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:node:browser-app:v1';
    const MIXINS = [
