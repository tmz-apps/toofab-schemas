...
{
    const SCHEMA_ID = 'pbj:toofab:iam:node:twitter-app:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:node:twitter-app';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:node:twitter-app:v1';
    const MIXINS = [
