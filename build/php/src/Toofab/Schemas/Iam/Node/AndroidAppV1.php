...
{
    const SCHEMA_ID = 'pbj:toofab:iam:node:android-app:1-0-0';
    const SCHEMA_CURIE = 'toofab:iam:node:android-app';
    const SCHEMA_CURIE_MAJOR = 'toofab:iam:node:android-app:v1';
    const MIXINS = [
