...
{
    const SCHEMA_ID = 'pbj:toofab:taxonomy:request:get-category-history-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:taxonomy:request:get-category-history-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:taxonomy:request:get-category-history-request:v1';
    const MIXINS = [
