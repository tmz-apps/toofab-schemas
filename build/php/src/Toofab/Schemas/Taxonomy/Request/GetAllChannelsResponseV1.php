...
{
    const SCHEMA_ID = 'pbj:toofab:taxonomy:request:get-all-channels-response:1-0-0';
    const SCHEMA_CURIE = 'toofab:taxonomy:request:get-all-channels-response';
    const SCHEMA_CURIE_MAJOR = 'toofab:taxonomy:request:get-all-channels-response:v1';
    const MIXINS = [
