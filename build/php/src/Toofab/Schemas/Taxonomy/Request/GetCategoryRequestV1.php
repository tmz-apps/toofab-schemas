...
{
    const SCHEMA_ID = 'pbj:toofab:taxonomy:request:get-category-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:taxonomy:request:get-category-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:taxonomy:request:get-category-request:v1';
    const MIXINS = [
