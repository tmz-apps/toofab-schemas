...
{
    const SCHEMA_ID = 'pbj:toofab:taxonomy:event:channel-updated:1-0-0';
    const SCHEMA_CURIE = 'toofab:taxonomy:event:channel-updated';
    const SCHEMA_CURIE_MAJOR = 'toofab:taxonomy:event:channel-updated:v1';
    const MIXINS = [
