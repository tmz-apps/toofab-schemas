...
{
    const SCHEMA_ID = 'pbj:toofab:taxonomy:event:category-updated:1-0-0';
    const SCHEMA_CURIE = 'toofab:taxonomy:event:category-updated';
    const SCHEMA_CURIE_MAJOR = 'toofab:taxonomy:event:category-updated:v1';
    const MIXINS = [
