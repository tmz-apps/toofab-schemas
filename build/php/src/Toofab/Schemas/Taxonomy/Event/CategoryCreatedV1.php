...
{
    const SCHEMA_ID = 'pbj:toofab:taxonomy:event:category-created:1-0-0';
    const SCHEMA_CURIE = 'toofab:taxonomy:event:category-created';
    const SCHEMA_CURIE_MAJOR = 'toofab:taxonomy:event:category-created:v1';
    const MIXINS = [
