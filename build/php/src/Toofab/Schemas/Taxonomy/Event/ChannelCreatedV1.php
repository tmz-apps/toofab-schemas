...
{
    const SCHEMA_ID = 'pbj:toofab:taxonomy:event:channel-created:1-0-0';
    const SCHEMA_CURIE = 'toofab:taxonomy:event:channel-created';
    const SCHEMA_CURIE_MAJOR = 'toofab:taxonomy:event:channel-created:v1';
    const MIXINS = [
