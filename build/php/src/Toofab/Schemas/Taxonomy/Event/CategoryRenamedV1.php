...
{
    const SCHEMA_ID = 'pbj:toofab:taxonomy:event:category-renamed:1-0-0';
    const SCHEMA_CURIE = 'toofab:taxonomy:event:category-renamed';
    const SCHEMA_CURIE_MAJOR = 'toofab:taxonomy:event:category-renamed:v1';
    const MIXINS = [
