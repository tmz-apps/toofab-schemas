...
{
    const SCHEMA_ID = 'pbj:toofab:taxonomy:event:category-deleted:1-0-0';
    const SCHEMA_CURIE = 'toofab:taxonomy:event:category-deleted';
    const SCHEMA_CURIE_MAJOR = 'toofab:taxonomy:event:category-deleted:v1';
    const MIXINS = [
