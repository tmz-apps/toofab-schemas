...
{
    const SCHEMA_ID = 'pbj:toofab:taxonomy:node:category:1-0-0';
    const SCHEMA_CURIE = 'toofab:taxonomy:node:category';
    const SCHEMA_CURIE_MAJOR = 'toofab:taxonomy:node:category:v1';
    const MIXINS = [
