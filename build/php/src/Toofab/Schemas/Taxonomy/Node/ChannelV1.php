...
{
    const SCHEMA_ID = 'pbj:toofab:taxonomy:node:channel:1-0-0';
    const SCHEMA_CURIE = 'toofab:taxonomy:node:channel';
    const SCHEMA_CURIE_MAJOR = 'toofab:taxonomy:node:channel:v1';
    const MIXINS = [
