...
{
    const SCHEMA_ID = 'pbj:toofab:taxonomy:command:update-channel:1-0-0';
    const SCHEMA_CURIE = 'toofab:taxonomy:command:update-channel';
    const SCHEMA_CURIE_MAJOR = 'toofab:taxonomy:command:update-channel:v1';
    const MIXINS = [
