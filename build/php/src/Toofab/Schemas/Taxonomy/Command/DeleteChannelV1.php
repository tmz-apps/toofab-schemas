...
{
    const SCHEMA_ID = 'pbj:toofab:taxonomy:command:delete-channel:1-0-0';
    const SCHEMA_CURIE = 'toofab:taxonomy:command:delete-channel';
    const SCHEMA_CURIE_MAJOR = 'toofab:taxonomy:command:delete-channel:v1';
    const MIXINS = [
