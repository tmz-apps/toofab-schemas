...
{
    const SCHEMA_ID = 'pbj:toofab:taxonomy:command:rename-channel:1-0-0';
    const SCHEMA_CURIE = 'toofab:taxonomy:command:rename-channel';
    const SCHEMA_CURIE_MAJOR = 'toofab:taxonomy:command:rename-channel:v1';
    const MIXINS = [
