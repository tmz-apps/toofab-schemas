...
{
    const SCHEMA_ID = 'pbj:toofab:taxonomy:command:create-category:1-0-0';
    const SCHEMA_CURIE = 'toofab:taxonomy:command:create-category';
    const SCHEMA_CURIE_MAJOR = 'toofab:taxonomy:command:create-category:v1';
    const MIXINS = [
