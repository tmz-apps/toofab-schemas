...
{
    const SCHEMA_ID = 'pbj:toofab:taxonomy:command:update-category:1-0-0';
    const SCHEMA_CURIE = 'toofab:taxonomy:command:update-category';
    const SCHEMA_CURIE_MAJOR = 'toofab:taxonomy:command:update-category:v1';
    const MIXINS = [
