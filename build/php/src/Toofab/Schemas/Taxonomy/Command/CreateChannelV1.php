...
{
    const SCHEMA_ID = 'pbj:toofab:taxonomy:command:create-channel:1-0-0';
    const SCHEMA_CURIE = 'toofab:taxonomy:command:create-channel';
    const SCHEMA_CURIE_MAJOR = 'toofab:taxonomy:command:create-channel:v1';
    const MIXINS = [
