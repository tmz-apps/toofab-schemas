...
namespace Toofab\Schemas\Taxonomy\Command;
...
{
    const SCHEMA_ID = 'pbj:toofab:taxonomy:command:rename-category:1-0-0';
    const SCHEMA_CURIE = 'toofab:taxonomy:command:rename-category';
    const SCHEMA_CURIE_MAJOR = 'toofab:taxonomy:command:rename-category:v1';
    const MIXINS = [
