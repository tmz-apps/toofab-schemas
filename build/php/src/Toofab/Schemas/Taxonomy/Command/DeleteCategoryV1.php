...
{
    const SCHEMA_ID = 'pbj:toofab:taxonomy:command:delete-category:1-0-0';
    const SCHEMA_CURIE = 'toofab:taxonomy:command:delete-category';
    const SCHEMA_CURIE_MAJOR = 'toofab:taxonomy:command:delete-category:v1';
    const MIXINS = [
