...
{
    const SCHEMA_ID = 'pbj:toofab:notify:command:send-notification:1-0-0';
    const SCHEMA_CURIE = 'toofab:notify:command:send-notification';
    const SCHEMA_CURIE_MAJOR = 'toofab:notify:command:send-notification:v1';
    const MIXINS = [
