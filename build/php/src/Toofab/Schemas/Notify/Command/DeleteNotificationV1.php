...
{
    const SCHEMA_ID = 'pbj:toofab:notify:command:delete-notification:1-0-0';
    const SCHEMA_CURIE = 'toofab:notify:command:delete-notification';
    const SCHEMA_CURIE_MAJOR = 'toofab:notify:command:delete-notification:v1';
    const MIXINS = [
