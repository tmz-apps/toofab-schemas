...
{
    const SCHEMA_ID = 'pbj:toofab:notify:command:create-notification:1-0-0';
    const SCHEMA_CURIE = 'toofab:notify:command:create-notification';
    const SCHEMA_CURIE_MAJOR = 'toofab:notify:command:create-notification:v1';
    const MIXINS = [
