...
{
    const SCHEMA_ID = 'pbj:toofab:notify:command:update-notification:1-0-0';
    const SCHEMA_CURIE = 'toofab:notify:command:update-notification';
    const SCHEMA_CURIE_MAJOR = 'toofab:notify:command:update-notification:v1';
    const MIXINS = [
