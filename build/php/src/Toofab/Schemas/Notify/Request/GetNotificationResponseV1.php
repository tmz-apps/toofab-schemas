...
{
    const SCHEMA_ID = 'pbj:toofab:notify:request:get-notification-response:1-0-0';
    const SCHEMA_CURIE = 'toofab:notify:request:get-notification-response';
    const SCHEMA_CURIE_MAJOR = 'toofab:notify:request:get-notification-response:v1';
    const MIXINS = [
