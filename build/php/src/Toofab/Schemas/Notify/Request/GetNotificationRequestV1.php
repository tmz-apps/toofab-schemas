...
{
    const SCHEMA_ID = 'pbj:toofab:notify:request:get-notification-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:notify:request:get-notification-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:notify:request:get-notification-request:v1';
    const MIXINS = [
