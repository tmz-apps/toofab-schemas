...
{
    const SCHEMA_ID = 'pbj:toofab:notify:request:search-notifications-response:1-0-0';
    const SCHEMA_CURIE = 'toofab:notify:request:search-notifications-response';
    const SCHEMA_CURIE_MAJOR = 'toofab:notify:request:search-notifications-response:v1';
    const MIXINS = [
