...
{
    const SCHEMA_ID = 'pbj:toofab:notify:request:search-notifications-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:notify:request:search-notifications-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:notify:request:search-notifications-request:v1';
    const MIXINS = [
