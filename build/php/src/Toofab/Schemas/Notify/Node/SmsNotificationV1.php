...
{
    const SCHEMA_ID = 'pbj:toofab:notify:node:sms-notification:1-0-0';
    const SCHEMA_CURIE = 'toofab:notify:node:sms-notification';
    const SCHEMA_CURIE_MAJOR = 'toofab:notify:node:sms-notification:v1';
    const MIXINS = [
