...
{
    const SCHEMA_ID = 'pbj:toofab:notify:node:alexa-notification:1-0-0';
    const SCHEMA_CURIE = 'toofab:notify:node:alexa-notification';
    const SCHEMA_CURIE_MAJOR = 'toofab:notify:node:alexa-notification:v1';
    const MIXINS = [
