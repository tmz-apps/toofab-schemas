...
{
    const SCHEMA_ID = 'pbj:toofab:notify:node:apple-news-notification:1-0-0';
    const SCHEMA_CURIE = 'toofab:notify:node:apple-news-notification';
    const SCHEMA_CURIE_MAJOR = 'toofab:notify:node:apple-news-notification:v1';
    const MIXINS = [
