...
{
    const SCHEMA_ID = 'pbj:toofab:notify:node:email-notification:1-0-0';
    const SCHEMA_CURIE = 'toofab:notify:node:email-notification';
    const SCHEMA_CURIE_MAJOR = 'toofab:notify:node:email-notification:v1';
    const MIXINS = [
