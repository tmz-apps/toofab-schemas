...
{
    const SCHEMA_ID = 'pbj:toofab:notify:node:ios-notification:1-0-0';
    const SCHEMA_CURIE = 'toofab:notify:node:ios-notification';
    const SCHEMA_CURIE_MAJOR = 'toofab:notify:node:ios-notification:v1';
    const MIXINS = [
