...
{
    const SCHEMA_ID = 'pbj:toofab:notify:node:twitter-notification:1-0-0';
    const SCHEMA_CURIE = 'toofab:notify:node:twitter-notification';
    const SCHEMA_CURIE_MAJOR = 'toofab:notify:node:twitter-notification:v1';
    const MIXINS = [
