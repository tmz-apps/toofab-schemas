...
{
    const SCHEMA_ID = 'pbj:toofab:notify:node:slack-notification:1-0-0';
    const SCHEMA_CURIE = 'toofab:notify:node:slack-notification';
    const SCHEMA_CURIE_MAJOR = 'toofab:notify:node:slack-notification:v1';
    const MIXINS = [
