...
{
    const SCHEMA_ID = 'pbj:toofab:notify:node:android-notification:1-0-0';
    const SCHEMA_CURIE = 'toofab:notify:node:android-notification';
    const SCHEMA_CURIE_MAJOR = 'toofab:notify:node:android-notification:v1';
    const MIXINS = [
