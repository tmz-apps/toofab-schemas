...
{
    const SCHEMA_ID = 'pbj:toofab:notify:node:browser-notification:1-0-0';
    const SCHEMA_CURIE = 'toofab:notify:node:browser-notification';
    const SCHEMA_CURIE_MAJOR = 'toofab:notify:node:browser-notification:v1';
    const MIXINS = [
