...
{
    const SCHEMA_ID = 'pbj:toofab:notify:event:notification-created:1-0-0';
    const SCHEMA_CURIE = 'toofab:notify:event:notification-created';
    const SCHEMA_CURIE_MAJOR = 'toofab:notify:event:notification-created:v1';
    const MIXINS = [
