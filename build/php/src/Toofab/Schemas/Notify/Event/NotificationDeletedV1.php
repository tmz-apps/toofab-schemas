...
{
    const SCHEMA_ID = 'pbj:toofab:notify:event:notification-deleted:1-0-0';
    const SCHEMA_CURIE = 'toofab:notify:event:notification-deleted';
    const SCHEMA_CURIE_MAJOR = 'toofab:notify:event:notification-deleted:v1';
    const MIXINS = [
