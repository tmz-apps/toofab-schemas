...
{
    const SCHEMA_ID = 'pbj:toofab:notify:event:notification-updated:1-0-0';
    const SCHEMA_CURIE = 'toofab:notify:event:notification-updated';
    const SCHEMA_CURIE_MAJOR = 'toofab:notify:event:notification-updated:v1';
    const MIXINS = [
