...
{
    const SCHEMA_ID = 'pbj:toofab:notify:event:notification-failed:1-0-0';
    const SCHEMA_CURIE = 'toofab:notify:event:notification-failed';
    const SCHEMA_CURIE_MAJOR = 'toofab:notify:event:notification-failed:v1';
    const MIXINS = [
