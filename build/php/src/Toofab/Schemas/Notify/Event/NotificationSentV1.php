...
{
    const SCHEMA_ID = 'pbj:toofab:notify:event:notification-sent:1-0-0';
    const SCHEMA_CURIE = 'toofab:notify:event:notification-sent';
    const SCHEMA_CURIE_MAJOR = 'toofab:notify:event:notification-sent:v1';
    const MIXINS = [
