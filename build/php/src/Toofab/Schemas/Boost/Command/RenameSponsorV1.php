...
{
    const SCHEMA_ID = 'pbj:toofab:boost:command:rename-sponsor:1-0-0';
    const SCHEMA_CURIE = 'toofab:boost:command:rename-sponsor';
    const SCHEMA_CURIE_MAJOR = 'toofab:boost:command:rename-sponsor:v1';
    const MIXINS = [
