...
{
    const SCHEMA_ID = 'pbj:toofab:boost:command:delete-sponsor:1-0-0';
    const SCHEMA_CURIE = 'toofab:boost:command:delete-sponsor';
    const SCHEMA_CURIE_MAJOR = 'toofab:boost:command:delete-sponsor:v1';
    const MIXINS = [
