...
{
    const SCHEMA_ID = 'pbj:toofab:boost:command:create-sponsor:1-0-0';
    const SCHEMA_CURIE = 'toofab:boost:command:create-sponsor';
    const SCHEMA_CURIE_MAJOR = 'toofab:boost:command:create-sponsor:v1';
    const MIXINS = [
