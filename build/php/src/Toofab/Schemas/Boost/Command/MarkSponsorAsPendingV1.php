...
namespace Toofab\Schemas\Boost\Command;
...
{
    const SCHEMA_ID = 'pbj:toofab:boost:command:mark-sponsor-as-pending:1-0-0';
    const SCHEMA_CURIE = 'toofab:boost:command:mark-sponsor-as-pending';
    const SCHEMA_CURIE_MAJOR = 'toofab:boost:command:mark-sponsor-as-pending:v1';
    const MIXINS = [
