...
{
    const SCHEMA_ID = 'pbj:toofab:boost:command:publish-sponsor:1-0-0';
    const SCHEMA_CURIE = 'toofab:boost:command:publish-sponsor';
    const SCHEMA_CURIE_MAJOR = 'toofab:boost:command:publish-sponsor:v1';
    const MIXINS = [
