...
{
    const SCHEMA_ID = 'pbj:toofab:boost:command:expire-sponsor:1-0-0';
    const SCHEMA_CURIE = 'toofab:boost:command:expire-sponsor';
    const SCHEMA_CURIE_MAJOR = 'toofab:boost:command:expire-sponsor:v1';
    const MIXINS = [
