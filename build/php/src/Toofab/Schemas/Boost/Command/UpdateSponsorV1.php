...
{
    const SCHEMA_ID = 'pbj:toofab:boost:command:update-sponsor:1-0-0';
    const SCHEMA_CURIE = 'toofab:boost:command:update-sponsor';
    const SCHEMA_CURIE_MAJOR = 'toofab:boost:command:update-sponsor:v1';
    const MIXINS = [
