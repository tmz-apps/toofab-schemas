...
namespace Toofab\Schemas\Boost\Event;
...
{
    const SCHEMA_ID = 'pbj:toofab:boost:event:sponsor-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'toofab:boost:event:sponsor-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'toofab:boost:event:sponsor-marked-as-pending:v1';
    const MIXINS = [
