...
{
    const SCHEMA_ID = 'pbj:toofab:boost:event:sponsor-published:1-0-0';
    const SCHEMA_CURIE = 'toofab:boost:event:sponsor-published';
    const SCHEMA_CURIE_MAJOR = 'toofab:boost:event:sponsor-published:v1';
    const MIXINS = [
