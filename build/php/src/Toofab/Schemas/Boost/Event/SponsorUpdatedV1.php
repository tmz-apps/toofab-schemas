...
{
    const SCHEMA_ID = 'pbj:toofab:boost:event:sponsor-updated:1-0-0';
    const SCHEMA_CURIE = 'toofab:boost:event:sponsor-updated';
    const SCHEMA_CURIE_MAJOR = 'toofab:boost:event:sponsor-updated:v1';
    const MIXINS = [
