...
{
    const SCHEMA_ID = 'pbj:toofab:boost:event:sponsor-created:1-0-0';
    const SCHEMA_CURIE = 'toofab:boost:event:sponsor-created';
    const SCHEMA_CURIE_MAJOR = 'toofab:boost:event:sponsor-created:v1';
    const MIXINS = [
