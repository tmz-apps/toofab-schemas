...
{
    const SCHEMA_ID = 'pbj:toofab:boost:event:sponsor-unpublished:1-0-0';
    const SCHEMA_CURIE = 'toofab:boost:event:sponsor-unpublished';
    const SCHEMA_CURIE_MAJOR = 'toofab:boost:event:sponsor-unpublished:v1';
    const MIXINS = [
