...
{
    const SCHEMA_ID = 'pbj:toofab:boost:event:sponsor-expired:1-0-0';
    const SCHEMA_CURIE = 'toofab:boost:event:sponsor-expired';
    const SCHEMA_CURIE_MAJOR = 'toofab:boost:event:sponsor-expired:v1';
    const MIXINS = [
