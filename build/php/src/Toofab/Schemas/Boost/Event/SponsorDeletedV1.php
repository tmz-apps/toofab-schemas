...
{
    const SCHEMA_ID = 'pbj:toofab:boost:event:sponsor-deleted:1-0-0';
    const SCHEMA_CURIE = 'toofab:boost:event:sponsor-deleted';
    const SCHEMA_CURIE_MAJOR = 'toofab:boost:event:sponsor-deleted:v1';
    const MIXINS = [
