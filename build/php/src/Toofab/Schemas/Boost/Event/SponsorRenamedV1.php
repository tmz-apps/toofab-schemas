...
{
    const SCHEMA_ID = 'pbj:toofab:boost:event:sponsor-renamed:1-0-0';
    const SCHEMA_CURIE = 'toofab:boost:event:sponsor-renamed';
    const SCHEMA_CURIE_MAJOR = 'toofab:boost:event:sponsor-renamed:v1';
    const MIXINS = [
