...
{
    const SCHEMA_ID = 'pbj:toofab:boost:request:get-sponsor-response:1-0-0';
    const SCHEMA_CURIE = 'toofab:boost:request:get-sponsor-response';
    const SCHEMA_CURIE_MAJOR = 'toofab:boost:request:get-sponsor-response:v1';
    const MIXINS = [
