...
{
    const SCHEMA_ID = 'pbj:toofab:boost:request:search-sponsors-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:boost:request:search-sponsors-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:boost:request:search-sponsors-request:v1';
    const MIXINS = [
