...
{
    const SCHEMA_ID = 'pbj:toofab:boost:request:search-sponsors-response:1-0-0';
    const SCHEMA_CURIE = 'toofab:boost:request:search-sponsors-response';
    const SCHEMA_CURIE_MAJOR = 'toofab:boost:request:search-sponsors-response:v1';
    const MIXINS = [
