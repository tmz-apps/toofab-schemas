...
{
    const SCHEMA_ID = 'pbj:toofab:boost:request:get-sponsor-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:boost:request:get-sponsor-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:boost:request:get-sponsor-request:v1';
    const MIXINS = [
