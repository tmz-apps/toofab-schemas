...
namespace Toofab\Schemas\Boost\Request;
...
{
    const SCHEMA_ID = 'pbj:toofab:boost:request:get-sponsor-history-response:1-0-0';
    const SCHEMA_CURIE = 'toofab:boost:request:get-sponsor-history-response';
    const SCHEMA_CURIE_MAJOR = 'toofab:boost:request:get-sponsor-history-response:v1';
    const MIXINS = [
