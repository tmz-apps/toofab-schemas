...
{
    const SCHEMA_ID = 'pbj:toofab:curator:node:channel-teaser:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:node:channel-teaser';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:node:channel-teaser:v1';
    const MIXINS = [
