...
{
    const SCHEMA_ID = 'pbj:toofab:curator:node:gallery:1-0-2';
    const SCHEMA_CURIE = 'toofab:curator:node:gallery';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:node:gallery:v1';
    const MIXINS = [
