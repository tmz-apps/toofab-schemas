...
{
    const SCHEMA_ID = 'pbj:toofab:curator:node:playlist-widget:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:node:playlist-widget';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:node:playlist-widget:v1';
    const MIXINS = [
