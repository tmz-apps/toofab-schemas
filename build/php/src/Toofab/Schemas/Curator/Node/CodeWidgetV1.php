...
{
    const SCHEMA_ID = 'pbj:toofab:curator:node:code-widget:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:node:code-widget';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:node:code-widget:v1';
    const MIXINS = [
