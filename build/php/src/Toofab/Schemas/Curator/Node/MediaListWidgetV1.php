...
{
    const SCHEMA_ID = 'pbj:toofab:curator:node:media-list-widget:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:node:media-list-widget';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:node:media-list-widget:v1';
    const MIXINS = [
