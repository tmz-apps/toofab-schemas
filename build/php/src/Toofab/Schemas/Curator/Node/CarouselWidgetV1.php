...
{
    const SCHEMA_ID = 'pbj:toofab:curator:node:carousel-widget:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:node:carousel-widget';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:node:carousel-widget:v1';
    const MIXINS = [
