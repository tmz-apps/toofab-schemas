...
{
    const SCHEMA_ID = 'pbj:toofab:curator:node:showtimes-widget:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:node:showtimes-widget';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:node:showtimes-widget:v1';
    const MIXINS = [
