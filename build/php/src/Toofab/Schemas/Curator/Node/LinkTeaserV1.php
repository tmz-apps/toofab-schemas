...
{
    const SCHEMA_ID = 'pbj:toofab:curator:node:link-teaser:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:node:link-teaser';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:node:link-teaser:v1';
    const MIXINS = [
