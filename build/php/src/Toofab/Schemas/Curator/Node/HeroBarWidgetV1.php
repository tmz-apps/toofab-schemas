...
{
    const SCHEMA_ID = 'pbj:toofab:curator:node:hero-bar-widget:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:node:hero-bar-widget';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:node:hero-bar-widget:v1';
    const MIXINS = [
