...
{
    const SCHEMA_ID = 'pbj:toofab:curator:node:timeline:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:node:timeline';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:node:timeline:v1';
    const MIXINS = [
