...
{
    const SCHEMA_ID = 'pbj:toofab:curator:node:timeline-teaser:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:node:timeline-teaser';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:node:timeline-teaser:v1';
    const MIXINS = [
