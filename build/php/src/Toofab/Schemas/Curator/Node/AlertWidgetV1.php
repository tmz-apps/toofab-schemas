...
{
    const SCHEMA_ID = 'pbj:toofab:curator:node:alert-widget:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:node:alert-widget';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:node:alert-widget:v1';
    const MIXINS = [
