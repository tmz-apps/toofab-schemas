...
{
    const SCHEMA_ID = 'pbj:toofab:curator:node:spotlight-widget:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:node:spotlight-widget';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:node:spotlight-widget:v1';
    const MIXINS = [
