...
{
    const SCHEMA_ID = 'pbj:toofab:curator:node:gallery-teaser:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:node:gallery-teaser';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:node:gallery-teaser:v1';
    const MIXINS = [
