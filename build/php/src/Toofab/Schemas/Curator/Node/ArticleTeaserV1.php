...
{
    const SCHEMA_ID = 'pbj:toofab:curator:node:article-teaser:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:node:article-teaser';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:node:article-teaser:v1';
    const MIXINS = [
