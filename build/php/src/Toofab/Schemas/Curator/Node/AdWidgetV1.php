...
{
    const SCHEMA_ID = 'pbj:toofab:curator:node:ad-widget:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:node:ad-widget';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:node:ad-widget:v1';
    const MIXINS = [
