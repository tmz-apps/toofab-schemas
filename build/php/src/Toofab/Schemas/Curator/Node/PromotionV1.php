...
{
    const SCHEMA_ID = 'pbj:toofab:curator:node:promotion:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:node:promotion';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:node:promotion:v1';
    const MIXINS = [
