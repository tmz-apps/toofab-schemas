...
{
    const SCHEMA_ID = 'pbj:toofab:curator:node:page-teaser:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:node:page-teaser';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:node:page-teaser:v1';
    const MIXINS = [
