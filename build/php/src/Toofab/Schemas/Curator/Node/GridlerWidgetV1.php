...
{
    const SCHEMA_ID = 'pbj:toofab:curator:node:gridler-widget:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:node:gridler-widget';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:node:gridler-widget:v1';
    const MIXINS = [
