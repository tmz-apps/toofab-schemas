...
{
    const SCHEMA_ID = 'pbj:toofab:curator:node:category-teaser:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:node:category-teaser';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:node:category-teaser:v1';
    const MIXINS = [
