...
{
    const SCHEMA_ID = 'pbj:toofab:curator:node:slider-widget:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:node:slider-widget';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:node:slider-widget:v1';
    const MIXINS = [
