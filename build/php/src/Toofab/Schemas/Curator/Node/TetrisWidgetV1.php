...
{
    const SCHEMA_ID = 'pbj:toofab:curator:node:tetris-widget:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:node:tetris-widget';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:node:tetris-widget:v1';
    const MIXINS = [
