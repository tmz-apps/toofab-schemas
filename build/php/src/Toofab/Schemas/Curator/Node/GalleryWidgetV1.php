...
{
    const SCHEMA_ID = 'pbj:toofab:curator:node:gallery-widget:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:node:gallery-widget';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:node:gallery-widget:v1';
    const MIXINS = [
