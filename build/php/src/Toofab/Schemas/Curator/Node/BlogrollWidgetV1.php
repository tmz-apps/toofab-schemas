...
{
    const SCHEMA_ID = 'pbj:toofab:curator:node:blogroll-widget:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:node:blogroll-widget';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:node:blogroll-widget:v1';
    const MIXINS = [
