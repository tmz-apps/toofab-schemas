...
{
    const SCHEMA_ID = 'pbj:toofab:curator:node:video-teaser:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:node:video-teaser';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:node:video-teaser:v1';
    const MIXINS = [
