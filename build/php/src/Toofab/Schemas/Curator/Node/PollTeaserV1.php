...
{
    const SCHEMA_ID = 'pbj:toofab:curator:node:poll-teaser:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:node:poll-teaser';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:node:poll-teaser:v1';
    const MIXINS = [
