...
{
    const SCHEMA_ID = 'pbj:toofab:curator:node:person-teaser:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:node:person-teaser';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:node:person-teaser:v1';
    const MIXINS = [
