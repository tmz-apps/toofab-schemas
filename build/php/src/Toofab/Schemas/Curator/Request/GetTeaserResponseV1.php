...
{
    const SCHEMA_ID = 'pbj:toofab:curator:request:get-teaser-response:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:request:get-teaser-response';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:request:get-teaser-response:v1';
    const MIXINS = [
