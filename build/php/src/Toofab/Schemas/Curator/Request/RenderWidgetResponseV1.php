...
{
    const SCHEMA_ID = 'pbj:toofab:curator:request:render-widget-response:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:request:render-widget-response';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:request:render-widget-response:v1';
    const MIXINS = [
