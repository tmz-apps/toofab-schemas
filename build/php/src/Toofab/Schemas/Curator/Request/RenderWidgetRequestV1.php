...
{
    const SCHEMA_ID = 'pbj:toofab:curator:request:render-widget-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:request:render-widget-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:request:render-widget-request:v1';
    const MIXINS = [
