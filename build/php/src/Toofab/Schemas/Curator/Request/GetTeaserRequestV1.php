...
{
    const SCHEMA_ID = 'pbj:toofab:curator:request:get-teaser-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:request:get-teaser-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:request:get-teaser-request:v1';
    const MIXINS = [
