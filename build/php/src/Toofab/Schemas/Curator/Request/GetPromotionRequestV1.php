...
{
    const SCHEMA_ID = 'pbj:toofab:curator:request:get-promotion-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:request:get-promotion-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:request:get-promotion-request:v1';
    const MIXINS = [
