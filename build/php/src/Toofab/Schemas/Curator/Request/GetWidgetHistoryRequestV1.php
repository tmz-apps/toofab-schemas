...
{
    const SCHEMA_ID = 'pbj:toofab:curator:request:get-widget-history-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:request:get-widget-history-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:request:get-widget-history-request:v1';
    const MIXINS = [
