...
{
    const SCHEMA_ID = 'pbj:toofab:curator:request:search-timelines-response:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:request:search-timelines-response';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:request:search-timelines-response:v1';
    const MIXINS = [
