...
{
    const SCHEMA_ID = 'pbj:toofab:curator:request:search-widgets-response:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:request:search-widgets-response';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:request:search-widgets-response:v1';
    const MIXINS = [
