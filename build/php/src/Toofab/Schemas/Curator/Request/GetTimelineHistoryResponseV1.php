...
{
    const SCHEMA_ID = 'pbj:toofab:curator:request:get-timeline-history-response:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:request:get-timeline-history-response';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:request:get-timeline-history-response:v1';
    const MIXINS = [
