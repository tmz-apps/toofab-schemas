...
{
    const SCHEMA_ID = 'pbj:toofab:curator:request:search-promotions-response:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:request:search-promotions-response';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:request:search-promotions-response:v1';
    const MIXINS = [
