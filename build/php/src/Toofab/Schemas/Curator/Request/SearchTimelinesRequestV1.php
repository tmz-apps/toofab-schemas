...
{
    const SCHEMA_ID = 'pbj:toofab:curator:request:search-timelines-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:request:search-timelines-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:request:search-timelines-request:v1';
    const MIXINS = [
