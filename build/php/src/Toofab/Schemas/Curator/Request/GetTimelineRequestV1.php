...
{
    const SCHEMA_ID = 'pbj:toofab:curator:request:get-timeline-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:request:get-timeline-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:request:get-timeline-request:v1';
    const MIXINS = [
