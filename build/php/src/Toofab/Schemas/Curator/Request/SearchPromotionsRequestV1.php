...
{
    const SCHEMA_ID = 'pbj:toofab:curator:request:search-promotions-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:request:search-promotions-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:request:search-promotions-request:v1';
    const MIXINS = [
