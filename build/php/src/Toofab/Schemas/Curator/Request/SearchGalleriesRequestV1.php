...
{
    const SCHEMA_ID = 'pbj:toofab:curator:request:search-galleries-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:request:search-galleries-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:request:search-galleries-request:v1';
    const MIXINS = [
