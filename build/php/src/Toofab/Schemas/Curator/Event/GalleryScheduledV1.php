...
{
    const SCHEMA_ID = 'pbj:toofab:curator:event:gallery-scheduled:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:event:gallery-scheduled';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:event:gallery-scheduled:v1';
    const MIXINS = [
