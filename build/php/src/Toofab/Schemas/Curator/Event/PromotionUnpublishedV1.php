...
{
    const SCHEMA_ID = 'pbj:toofab:curator:event:promotion-unpublished:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:event:promotion-unpublished';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:event:promotion-unpublished:v1';
    const MIXINS = [
