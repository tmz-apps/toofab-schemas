...
{
    const SCHEMA_ID = 'pbj:toofab:curator:event:promotion-expired:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:event:promotion-expired';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:event:promotion-expired:v1';
    const MIXINS = [
