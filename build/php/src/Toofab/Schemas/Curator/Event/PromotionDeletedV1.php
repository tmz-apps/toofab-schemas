...
{
    const SCHEMA_ID = 'pbj:toofab:curator:event:promotion-deleted:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:event:promotion-deleted';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:event:promotion-deleted:v1';
    const MIXINS = [
