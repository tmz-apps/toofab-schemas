...
{
    const SCHEMA_ID = 'pbj:toofab:curator:event:timeline-expired:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:event:timeline-expired';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:event:timeline-expired:v1';
    const MIXINS = [
