...
{
    const SCHEMA_ID = 'pbj:toofab:curator:event:timeline-published:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:event:timeline-published';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:event:timeline-published:v1';
    const MIXINS = [
