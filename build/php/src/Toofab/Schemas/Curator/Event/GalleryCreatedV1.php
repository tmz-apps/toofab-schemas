...
{
    const SCHEMA_ID = 'pbj:toofab:curator:event:gallery-created:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:event:gallery-created';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:event:gallery-created:v1';
    const MIXINS = [
