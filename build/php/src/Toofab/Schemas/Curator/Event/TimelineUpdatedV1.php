...
{
    const SCHEMA_ID = 'pbj:toofab:curator:event:timeline-updated:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:event:timeline-updated';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:event:timeline-updated:v1';
    const MIXINS = [
