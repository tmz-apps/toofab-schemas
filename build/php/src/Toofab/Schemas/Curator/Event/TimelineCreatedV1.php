...
{
    const SCHEMA_ID = 'pbj:toofab:curator:event:timeline-created:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:event:timeline-created';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:event:timeline-created:v1';
    const MIXINS = [
