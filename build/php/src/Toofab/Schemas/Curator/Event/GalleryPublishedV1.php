...
{
    const SCHEMA_ID = 'pbj:toofab:curator:event:gallery-published:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:event:gallery-published';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:event:gallery-published:v1';
    const MIXINS = [
