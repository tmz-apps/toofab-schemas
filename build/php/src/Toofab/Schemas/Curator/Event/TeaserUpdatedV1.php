...
{
    const SCHEMA_ID = 'pbj:toofab:curator:event:teaser-updated:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:event:teaser-updated';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:event:teaser-updated:v1';
    const MIXINS = [
