...
{
    const SCHEMA_ID = 'pbj:toofab:curator:event:promotion-published:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:event:promotion-published';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:event:promotion-published:v1';
    const MIXINS = [
