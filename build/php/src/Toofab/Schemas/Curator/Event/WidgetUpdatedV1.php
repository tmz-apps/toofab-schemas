...
{
    const SCHEMA_ID = 'pbj:toofab:curator:event:widget-updated:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:event:widget-updated';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:event:widget-updated:v1';
    const MIXINS = [
