...
{
    const SCHEMA_ID = 'pbj:toofab:curator:event:gallery-expired:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:event:gallery-expired';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:event:gallery-expired:v1';
    const MIXINS = [
