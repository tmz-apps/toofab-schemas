...
{
    const SCHEMA_ID = 'pbj:toofab:curator:event:widget-deleted:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:event:widget-deleted';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:event:widget-deleted:v1';
    const MIXINS = [
