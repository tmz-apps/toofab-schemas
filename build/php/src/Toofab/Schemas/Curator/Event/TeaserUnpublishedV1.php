...
{
    const SCHEMA_ID = 'pbj:toofab:curator:event:teaser-unpublished:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:event:teaser-unpublished';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:event:teaser-unpublished:v1';
    const MIXINS = [
