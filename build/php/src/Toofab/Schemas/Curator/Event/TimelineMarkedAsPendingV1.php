...
{
    const SCHEMA_ID = 'pbj:toofab:curator:event:timeline-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:event:timeline-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:event:timeline-marked-as-pending:v1';
    const MIXINS = [
