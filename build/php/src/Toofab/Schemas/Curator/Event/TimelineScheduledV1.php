...
{
    const SCHEMA_ID = 'pbj:toofab:curator:event:timeline-scheduled:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:event:timeline-scheduled';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:event:timeline-scheduled:v1';
    const MIXINS = [
