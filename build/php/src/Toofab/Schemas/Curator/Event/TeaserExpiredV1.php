...
{
    const SCHEMA_ID = 'pbj:toofab:curator:event:teaser-expired:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:event:teaser-expired';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:event:teaser-expired:v1';
    const MIXINS = [
