...
{
    const SCHEMA_ID = 'pbj:toofab:curator:event:widget-created:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:event:widget-created';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:event:widget-created:v1';
    const MIXINS = [
