...
{
    const SCHEMA_ID = 'pbj:toofab:curator:event:timeline-renamed:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:event:timeline-renamed';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:event:timeline-renamed:v1';
    const MIXINS = [
