...
{
    const SCHEMA_ID = 'pbj:toofab:curator:event:gallery-deleted:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:event:gallery-deleted';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:event:gallery-deleted:v1';
    const MIXINS = [
