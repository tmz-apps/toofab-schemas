...
{
    const SCHEMA_ID = 'pbj:toofab:curator:event:timeline-deleted:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:event:timeline-deleted';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:event:timeline-deleted:v1';
    const MIXINS = [
