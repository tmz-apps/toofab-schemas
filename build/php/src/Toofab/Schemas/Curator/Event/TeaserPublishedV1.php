...
{
    const SCHEMA_ID = 'pbj:toofab:curator:event:teaser-published:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:event:teaser-published';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:event:teaser-published:v1';
    const MIXINS = [
