...
{
    const SCHEMA_ID = 'pbj:toofab:curator:event:promotion-updated:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:event:promotion-updated';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:event:promotion-updated:v1';
    const MIXINS = [
