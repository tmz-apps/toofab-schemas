...
{
    const SCHEMA_ID = 'pbj:toofab:curator:event:promotion-scheduled:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:event:promotion-scheduled';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:event:promotion-scheduled:v1';
    const MIXINS = [
