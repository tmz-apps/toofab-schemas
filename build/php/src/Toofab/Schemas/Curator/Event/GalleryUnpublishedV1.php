...
{
    const SCHEMA_ID = 'pbj:toofab:curator:event:gallery-unpublished:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:event:gallery-unpublished';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:event:gallery-unpublished:v1';
    const MIXINS = [
