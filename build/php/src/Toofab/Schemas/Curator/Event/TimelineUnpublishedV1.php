...
{
    const SCHEMA_ID = 'pbj:toofab:curator:event:timeline-unpublished:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:event:timeline-unpublished';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:event:timeline-unpublished:v1';
    const MIXINS = [
