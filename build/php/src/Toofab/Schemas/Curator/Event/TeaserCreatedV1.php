...
{
    const SCHEMA_ID = 'pbj:toofab:curator:event:teaser-created:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:event:teaser-created';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:event:teaser-created:v1';
    const MIXINS = [
