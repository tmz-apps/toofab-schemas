...
{
    const SCHEMA_ID = 'pbj:toofab:curator:event:promotion-created:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:event:promotion-created';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:event:promotion-created:v1';
    const MIXINS = [
