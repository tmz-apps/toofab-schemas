...
{
    const SCHEMA_ID = 'pbj:toofab:curator:event:teaser-scheduled:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:event:teaser-scheduled';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:event:teaser-scheduled:v1';
    const MIXINS = [
