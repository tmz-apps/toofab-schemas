...
{
    const SCHEMA_ID = 'pbj:toofab:curator:event:teaser-deleted:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:event:teaser-deleted';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:event:teaser-deleted:v1';
    const MIXINS = [
