...
{
    const SCHEMA_ID = 'pbj:toofab:curator:event:gallery-renamed:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:event:gallery-renamed';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:event:gallery-renamed:v1';
    const MIXINS = [
