...
{
    const SCHEMA_ID = 'pbj:toofab:curator:command:create-timeline:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:command:create-timeline';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:command:create-timeline:v1';
    const MIXINS = [
