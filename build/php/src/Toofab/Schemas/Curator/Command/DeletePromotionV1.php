...
{
    const SCHEMA_ID = 'pbj:toofab:curator:command:delete-promotion:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:command:delete-promotion';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:command:delete-promotion:v1';
    const MIXINS = [
