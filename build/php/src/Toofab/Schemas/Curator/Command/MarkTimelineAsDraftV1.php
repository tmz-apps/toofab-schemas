...
{
    const SCHEMA_ID = 'pbj:toofab:curator:command:mark-timeline-as-draft:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:command:mark-timeline-as-draft';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:command:mark-timeline-as-draft:v1';
    const MIXINS = [
