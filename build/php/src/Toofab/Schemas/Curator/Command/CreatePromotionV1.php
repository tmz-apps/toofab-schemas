...
{
    const SCHEMA_ID = 'pbj:toofab:curator:command:create-promotion:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:command:create-promotion';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:command:create-promotion:v1';
    const MIXINS = [
