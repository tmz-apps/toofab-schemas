...
{
    const SCHEMA_ID = 'pbj:toofab:curator:command:update-teaser:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:command:update-teaser';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:command:update-teaser:v1';
    const MIXINS = [
