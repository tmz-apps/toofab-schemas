...
namespace Toofab\Schemas\Curator\Command;
...
{
    const SCHEMA_ID = 'pbj:toofab:curator:command:update-gallery-image-count:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:command:update-gallery-image-count';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:command:update-gallery-image-count:v1';
    const MIXINS = [
