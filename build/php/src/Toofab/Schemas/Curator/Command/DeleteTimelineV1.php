...
{
    const SCHEMA_ID = 'pbj:toofab:curator:command:delete-timeline:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:command:delete-timeline';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:command:delete-timeline:v1';
    const MIXINS = [
