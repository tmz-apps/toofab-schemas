...
{
    const SCHEMA_ID = 'pbj:toofab:curator:command:sync-teaser:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:command:sync-teaser';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:command:sync-teaser:v1';
    const MIXINS = [
