...
{
    const SCHEMA_ID = 'pbj:toofab:curator:command:publish-teaser:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:command:publish-teaser';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:command:publish-teaser:v1';
    const MIXINS = [
