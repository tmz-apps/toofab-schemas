...
{
    const SCHEMA_ID = 'pbj:toofab:curator:command:publish-promotion:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:command:publish-promotion';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:command:publish-promotion:v1';
    const MIXINS = [
