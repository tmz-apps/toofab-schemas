...
{
    const SCHEMA_ID = 'pbj:toofab:curator:command:create-teaser:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:command:create-teaser';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:command:create-teaser:v1';
    const MIXINS = [
