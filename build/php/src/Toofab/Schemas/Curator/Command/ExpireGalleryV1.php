...
{
    const SCHEMA_ID = 'pbj:toofab:curator:command:expire-gallery:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:command:expire-gallery';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:command:expire-gallery:v1';
    const MIXINS = [
