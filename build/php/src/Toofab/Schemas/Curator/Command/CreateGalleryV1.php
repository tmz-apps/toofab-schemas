...
{
    const SCHEMA_ID = 'pbj:toofab:curator:command:create-gallery:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:command:create-gallery';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:command:create-gallery:v1';
    const MIXINS = [
