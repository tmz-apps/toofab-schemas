...
{
    const SCHEMA_ID = 'pbj:toofab:curator:command:expire-promotion:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:command:expire-promotion';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:command:expire-promotion:v1';
    const MIXINS = [
