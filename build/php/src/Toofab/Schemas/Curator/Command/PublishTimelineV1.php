...
{
    const SCHEMA_ID = 'pbj:toofab:curator:command:publish-timeline:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:command:publish-timeline';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:command:publish-timeline:v1';
    const MIXINS = [
