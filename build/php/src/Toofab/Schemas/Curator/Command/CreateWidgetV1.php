...
{
    const SCHEMA_ID = 'pbj:toofab:curator:command:create-widget:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:command:create-widget';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:command:create-widget:v1';
    const MIXINS = [
