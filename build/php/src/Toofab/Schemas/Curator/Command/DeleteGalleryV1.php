...
{
    const SCHEMA_ID = 'pbj:toofab:curator:command:delete-gallery:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:command:delete-gallery';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:command:delete-gallery:v1';
    const MIXINS = [
