...
{
    const SCHEMA_ID = 'pbj:toofab:curator:command:rename-timeline:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:command:rename-timeline';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:command:rename-timeline:v1';
    const MIXINS = [
