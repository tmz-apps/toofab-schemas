...
{
    const SCHEMA_ID = 'pbj:toofab:curator:command:update-gallery:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:command:update-gallery';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:command:update-gallery:v1';
    const MIXINS = [
