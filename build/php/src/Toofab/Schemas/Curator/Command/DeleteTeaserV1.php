...
{
    const SCHEMA_ID = 'pbj:toofab:curator:command:delete-teaser:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:command:delete-teaser';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:command:delete-teaser:v1';
    const MIXINS = [
