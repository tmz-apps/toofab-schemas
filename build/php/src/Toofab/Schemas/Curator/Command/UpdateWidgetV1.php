...
{
    const SCHEMA_ID = 'pbj:toofab:curator:command:update-widget:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:command:update-widget';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:command:update-widget:v1';
    const MIXINS = [
