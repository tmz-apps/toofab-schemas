...
{
    const SCHEMA_ID = 'pbj:toofab:curator:command:unpublish-timeline:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:command:unpublish-timeline';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:command:unpublish-timeline:v1';
    const MIXINS = [
