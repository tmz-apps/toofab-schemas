...
{
    const SCHEMA_ID = 'pbj:toofab:curator:command:update-promotion:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:command:update-promotion';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:command:update-promotion:v1';
    const MIXINS = [
