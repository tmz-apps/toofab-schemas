...
{
    const SCHEMA_ID = 'pbj:toofab:curator:command:update-timeline:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:command:update-timeline';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:command:update-timeline:v1';
    const MIXINS = [
