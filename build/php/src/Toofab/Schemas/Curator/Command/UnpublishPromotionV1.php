...
{
    const SCHEMA_ID = 'pbj:toofab:curator:command:unpublish-promotion:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:command:unpublish-promotion';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:command:unpublish-promotion:v1';
    const MIXINS = [
