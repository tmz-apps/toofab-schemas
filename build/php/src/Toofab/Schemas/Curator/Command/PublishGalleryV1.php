...
{
    const SCHEMA_ID = 'pbj:toofab:curator:command:publish-gallery:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:command:publish-gallery';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:command:publish-gallery:v1';
    const MIXINS = [
