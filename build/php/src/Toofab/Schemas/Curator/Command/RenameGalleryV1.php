...
{
    const SCHEMA_ID = 'pbj:toofab:curator:command:rename-gallery:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:command:rename-gallery';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:command:rename-gallery:v1';
    const MIXINS = [
