...
{
    const SCHEMA_ID = 'pbj:toofab:curator:command:expire-teaser:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:command:expire-teaser';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:command:expire-teaser:v1';
    const MIXINS = [
