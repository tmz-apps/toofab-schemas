...
{
    const SCHEMA_ID = 'pbj:toofab:curator:command:unpublish-teaser:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:command:unpublish-teaser';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:command:unpublish-teaser:v1';
    const MIXINS = [
