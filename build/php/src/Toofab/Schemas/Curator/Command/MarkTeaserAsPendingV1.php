...
{
    const SCHEMA_ID = 'pbj:toofab:curator:command:mark-teaser-as-pending:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:command:mark-teaser-as-pending';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:command:mark-teaser-as-pending:v1';
    const MIXINS = [
