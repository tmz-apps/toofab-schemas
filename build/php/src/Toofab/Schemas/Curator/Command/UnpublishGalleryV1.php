...
{
    const SCHEMA_ID = 'pbj:toofab:curator:command:unpublish-gallery:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:command:unpublish-gallery';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:command:unpublish-gallery:v1';
    const MIXINS = [
