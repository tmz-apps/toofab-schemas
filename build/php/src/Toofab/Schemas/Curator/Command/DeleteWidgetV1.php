...
{
    const SCHEMA_ID = 'pbj:toofab:curator:command:delete-widget:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:command:delete-widget';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:command:delete-widget:v1';
    const MIXINS = [
