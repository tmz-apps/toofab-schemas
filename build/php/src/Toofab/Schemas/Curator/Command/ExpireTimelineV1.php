...
{
    const SCHEMA_ID = 'pbj:toofab:curator:command:expire-timeline:1-0-0';
    const SCHEMA_CURIE = 'toofab:curator:command:expire-timeline';
    const SCHEMA_CURIE_MAJOR = 'toofab:curator:command:expire-timeline:v1';
    const MIXINS = [
