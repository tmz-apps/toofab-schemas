...
{
    const SCHEMA_ID = 'pbj:toofab:sys:event:redirect-deleted:1-0-0';
    const SCHEMA_CURIE = 'toofab:sys:event:redirect-deleted';
    const SCHEMA_CURIE_MAJOR = 'toofab:sys:event:redirect-deleted:v1';
    const MIXINS = [
