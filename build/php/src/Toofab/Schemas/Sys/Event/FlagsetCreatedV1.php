...
{
    const SCHEMA_ID = 'pbj:toofab:sys:event:flagset-created:1-0-0';
    const SCHEMA_CURIE = 'toofab:sys:event:flagset-created';
    const SCHEMA_CURIE_MAJOR = 'toofab:sys:event:flagset-created:v1';
    const MIXINS = [
