...
namespace Toofab\Schemas\Sys\Event;
...
{
    const SCHEMA_ID = 'pbj:toofab:sys:event:picklist-updated:1-0-0';
    const SCHEMA_CURIE = 'toofab:sys:event:picklist-updated';
    const SCHEMA_CURIE_MAJOR = 'toofab:sys:event:picklist-updated:v1';
    const MIXINS = [
