...
{
    const SCHEMA_ID = 'pbj:toofab:sys:event:picklist-deleted:1-0-0';
    const SCHEMA_CURIE = 'toofab:sys:event:picklist-deleted';
    const SCHEMA_CURIE_MAJOR = 'toofab:sys:event:picklist-deleted:v1';
    const MIXINS = [
