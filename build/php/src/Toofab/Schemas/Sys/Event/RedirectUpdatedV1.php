...
{
    const SCHEMA_ID = 'pbj:toofab:sys:event:redirect-updated:1-0-0';
    const SCHEMA_CURIE = 'toofab:sys:event:redirect-updated';
    const SCHEMA_CURIE_MAJOR = 'toofab:sys:event:redirect-updated:v1';
    const MIXINS = [
