...
{
    const SCHEMA_ID = 'pbj:toofab:sys:event:flagset-updated:1-0-0';
    const SCHEMA_CURIE = 'toofab:sys:event:flagset-updated';
    const SCHEMA_CURIE_MAJOR = 'toofab:sys:event:flagset-updated:v1';
    const MIXINS = [
