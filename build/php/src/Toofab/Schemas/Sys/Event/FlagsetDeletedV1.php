...
{
    const SCHEMA_ID = 'pbj:toofab:sys:event:flagset-deleted:1-0-0';
    const SCHEMA_CURIE = 'toofab:sys:event:flagset-deleted';
    const SCHEMA_CURIE_MAJOR = 'toofab:sys:event:flagset-deleted:v1';
    const MIXINS = [
