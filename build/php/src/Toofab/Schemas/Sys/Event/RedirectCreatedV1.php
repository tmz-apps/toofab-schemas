...
{
    const SCHEMA_ID = 'pbj:toofab:sys:event:redirect-created:1-0-0';
    const SCHEMA_CURIE = 'toofab:sys:event:redirect-created';
    const SCHEMA_CURIE_MAJOR = 'toofab:sys:event:redirect-created:v1';
    const MIXINS = [
