...
{
    const SCHEMA_ID = 'pbj:toofab:sys:event:picklist-created:1-0-0';
    const SCHEMA_CURIE = 'toofab:sys:event:picklist-created';
    const SCHEMA_CURIE_MAJOR = 'toofab:sys:event:picklist-created:v1';
    const MIXINS = [
