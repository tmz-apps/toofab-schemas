...
{
    const SCHEMA_ID = 'pbj:toofab:sys:command:create-flagset:1-0-0';
    const SCHEMA_CURIE = 'toofab:sys:command:create-flagset';
    const SCHEMA_CURIE_MAJOR = 'toofab:sys:command:create-flagset:v1';
    const MIXINS = [
