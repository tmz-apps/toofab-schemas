...
{
    const SCHEMA_ID = 'pbj:toofab:sys:command:update-flagset:1-0-0';
    const SCHEMA_CURIE = 'toofab:sys:command:update-flagset';
    const SCHEMA_CURIE_MAJOR = 'toofab:sys:command:update-flagset:v1';
    const MIXINS = [
