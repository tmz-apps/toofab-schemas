...
{
    const SCHEMA_ID = 'pbj:toofab:sys:command:update-picklist:1-0-0';
    const SCHEMA_CURIE = 'toofab:sys:command:update-picklist';
    const SCHEMA_CURIE_MAJOR = 'toofab:sys:command:update-picklist:v1';
    const MIXINS = [
