...
{
    const SCHEMA_ID = 'pbj:toofab:sys:command:update-redirect:1-0-0';
    const SCHEMA_CURIE = 'toofab:sys:command:update-redirect';
    const SCHEMA_CURIE_MAJOR = 'toofab:sys:command:update-redirect:v1';
    const MIXINS = [
