...
{
    const SCHEMA_ID = 'pbj:toofab:sys:command:delete-redirect:1-0-0';
    const SCHEMA_CURIE = 'toofab:sys:command:delete-redirect';
    const SCHEMA_CURIE_MAJOR = 'toofab:sys:command:delete-redirect:v1';
    const MIXINS = [
