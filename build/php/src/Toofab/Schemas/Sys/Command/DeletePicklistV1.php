...
{
    const SCHEMA_ID = 'pbj:toofab:sys:command:delete-picklist:1-0-0';
    const SCHEMA_CURIE = 'toofab:sys:command:delete-picklist';
    const SCHEMA_CURIE_MAJOR = 'toofab:sys:command:delete-picklist:v1';
    const MIXINS = [
