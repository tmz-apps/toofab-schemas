...
{
    const SCHEMA_ID = 'pbj:toofab:sys:command:create-redirect:1-0-0';
    const SCHEMA_CURIE = 'toofab:sys:command:create-redirect';
    const SCHEMA_CURIE_MAJOR = 'toofab:sys:command:create-redirect:v1';
    const MIXINS = [
