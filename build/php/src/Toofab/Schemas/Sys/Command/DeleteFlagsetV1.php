...
{
    const SCHEMA_ID = 'pbj:toofab:sys:command:delete-flagset:1-0-0';
    const SCHEMA_CURIE = 'toofab:sys:command:delete-flagset';
    const SCHEMA_CURIE_MAJOR = 'toofab:sys:command:delete-flagset:v1';
    const MIXINS = [
