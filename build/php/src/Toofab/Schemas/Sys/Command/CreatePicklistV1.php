...
{
    const SCHEMA_ID = 'pbj:toofab:sys:command:create-picklist:1-0-0';
    const SCHEMA_CURIE = 'toofab:sys:command:create-picklist';
    const SCHEMA_CURIE_MAJOR = 'toofab:sys:command:create-picklist:v1';
    const MIXINS = [
