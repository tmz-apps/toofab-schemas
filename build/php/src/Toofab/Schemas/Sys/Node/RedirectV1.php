...
namespace Toofab\Schemas\Sys\Node;
...
{
    const SCHEMA_ID = 'pbj:toofab:sys:node:redirect:1-0-0';
    const SCHEMA_CURIE = 'toofab:sys:node:redirect';
    const SCHEMA_CURIE_MAJOR = 'toofab:sys:node:redirect:v1';
    const MIXINS = [
