...
{
    const SCHEMA_ID = 'pbj:toofab:sys:request:get-redirect-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:sys:request:get-redirect-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:sys:request:get-redirect-request:v1';
    const MIXINS = [
