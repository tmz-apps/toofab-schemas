...
{
    const SCHEMA_ID = 'pbj:toofab:sys:request:get-flagset-history-response:1-0-0';
    const SCHEMA_CURIE = 'toofab:sys:request:get-flagset-history-response';
    const SCHEMA_CURIE_MAJOR = 'toofab:sys:request:get-flagset-history-response:v1';
    const MIXINS = [
