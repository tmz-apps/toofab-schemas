...
{
    const SCHEMA_ID = 'pbj:toofab:sys:request:get-flagset-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:sys:request:get-flagset-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:sys:request:get-flagset-request:v1';
    const MIXINS = [
