...
{
    const SCHEMA_ID = 'pbj:toofab:sys:request:search-redirects-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:sys:request:search-redirects-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:sys:request:search-redirects-request:v1';
    const MIXINS = [
