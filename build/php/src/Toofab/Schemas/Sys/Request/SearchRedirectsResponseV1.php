...
{
    const SCHEMA_ID = 'pbj:toofab:sys:request:search-redirects-response:1-0-0';
    const SCHEMA_CURIE = 'toofab:sys:request:search-redirects-response';
    const SCHEMA_CURIE_MAJOR = 'toofab:sys:request:search-redirects-response:v1';
    const MIXINS = [
