...
{
    const SCHEMA_ID = 'pbj:toofab:sys:request:get-picklist-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:sys:request:get-picklist-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:sys:request:get-picklist-request:v1';
    const MIXINS = [
