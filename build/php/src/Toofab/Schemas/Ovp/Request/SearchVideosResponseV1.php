...
{
    const SCHEMA_ID = 'pbj:toofab:ovp:request:search-videos-response:1-0-0';
    const SCHEMA_CURIE = 'toofab:ovp:request:search-videos-response';
    const SCHEMA_CURIE_MAJOR = 'toofab:ovp:request:search-videos-response:v1';
    const MIXINS = [
