...
{
    const SCHEMA_ID = 'pbj:toofab:ovp:request:search-videos-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:ovp:request:search-videos-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:ovp:request:search-videos-request:v1';
    const MIXINS = [
