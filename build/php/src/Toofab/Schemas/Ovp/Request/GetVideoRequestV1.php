...
{
    const SCHEMA_ID = 'pbj:toofab:ovp:request:get-video-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:ovp:request:get-video-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:ovp:request:get-video-request:v1';
    const MIXINS = [
