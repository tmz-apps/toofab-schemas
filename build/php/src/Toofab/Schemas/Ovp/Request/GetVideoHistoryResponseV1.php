...
namespace Toofab\Schemas\Ovp\Request;
...
{
    const SCHEMA_ID = 'pbj:toofab:ovp:request:get-video-history-response:1-0-0';
    const SCHEMA_CURIE = 'toofab:ovp:request:get-video-history-response';
    const SCHEMA_CURIE_MAJOR = 'toofab:ovp:request:get-video-history-response:v1';
    const MIXINS = [
