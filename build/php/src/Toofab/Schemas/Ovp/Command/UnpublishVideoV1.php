...
{
    const SCHEMA_ID = 'pbj:toofab:ovp:command:unpublish-video:1-0-0';
    const SCHEMA_CURIE = 'toofab:ovp:command:unpublish-video';
    const SCHEMA_CURIE_MAJOR = 'toofab:ovp:command:unpublish-video:v1';
    const MIXINS = [
