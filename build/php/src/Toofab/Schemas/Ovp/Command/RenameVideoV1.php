...
{
    const SCHEMA_ID = 'pbj:toofab:ovp:command:rename-video:1-0-0';
    const SCHEMA_CURIE = 'toofab:ovp:command:rename-video';
    const SCHEMA_CURIE_MAJOR = 'toofab:ovp:command:rename-video:v1';
    const MIXINS = [
