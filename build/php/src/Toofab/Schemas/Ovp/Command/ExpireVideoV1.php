...
{
    const SCHEMA_ID = 'pbj:toofab:ovp:command:expire-video:1-0-0';
    const SCHEMA_CURIE = 'toofab:ovp:command:expire-video';
    const SCHEMA_CURIE_MAJOR = 'toofab:ovp:command:expire-video:v1';
    const MIXINS = [
