...
{
    const SCHEMA_ID = 'pbj:toofab:ovp:command:update-video:1-0-0';
    const SCHEMA_CURIE = 'toofab:ovp:command:update-video';
    const SCHEMA_CURIE_MAJOR = 'toofab:ovp:command:update-video:v1';
    const MIXINS = [
