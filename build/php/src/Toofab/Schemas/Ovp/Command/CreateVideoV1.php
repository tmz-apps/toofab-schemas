...
{
    const SCHEMA_ID = 'pbj:toofab:ovp:command:create-video:1-0-0';
    const SCHEMA_CURIE = 'toofab:ovp:command:create-video';
    const SCHEMA_CURIE_MAJOR = 'toofab:ovp:command:create-video:v1';
    const MIXINS = [
