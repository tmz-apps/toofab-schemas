...
{
    const SCHEMA_ID = 'pbj:toofab:ovp:command:publish-video:1-0-0';
    const SCHEMA_CURIE = 'toofab:ovp:command:publish-video';
    const SCHEMA_CURIE_MAJOR = 'toofab:ovp:command:publish-video:v1';
    const MIXINS = [
