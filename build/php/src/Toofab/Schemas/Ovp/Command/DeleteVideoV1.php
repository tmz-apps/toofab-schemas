...
{
    const SCHEMA_ID = 'pbj:toofab:ovp:command:delete-video:1-0-0';
    const SCHEMA_CURIE = 'toofab:ovp:command:delete-video';
    const SCHEMA_CURIE_MAJOR = 'toofab:ovp:command:delete-video:v1';
    const MIXINS = [
