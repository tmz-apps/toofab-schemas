...
{
    const SCHEMA_ID = 'pbj:toofab:ovp:event:video-scheduled:1-0-0';
    const SCHEMA_CURIE = 'toofab:ovp:event:video-scheduled';
    const SCHEMA_CURIE_MAJOR = 'toofab:ovp:event:video-scheduled:v1';
    const MIXINS = [
