...
{
    const SCHEMA_ID = 'pbj:toofab:ovp:event:video-unpublished:1-0-0';
    const SCHEMA_CURIE = 'toofab:ovp:event:video-unpublished';
    const SCHEMA_CURIE_MAJOR = 'toofab:ovp:event:video-unpublished:v1';
    const MIXINS = [
