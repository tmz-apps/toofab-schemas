...
{
    const SCHEMA_ID = 'pbj:toofab:ovp:event:video-expired:1-0-0';
    const SCHEMA_CURIE = 'toofab:ovp:event:video-expired';
    const SCHEMA_CURIE_MAJOR = 'toofab:ovp:event:video-expired:v1';
    const MIXINS = [
