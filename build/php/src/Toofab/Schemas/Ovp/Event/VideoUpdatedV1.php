...
{
    const SCHEMA_ID = 'pbj:toofab:ovp:event:video-updated:1-0-0';
    const SCHEMA_CURIE = 'toofab:ovp:event:video-updated';
    const SCHEMA_CURIE_MAJOR = 'toofab:ovp:event:video-updated:v1';
    const MIXINS = [
