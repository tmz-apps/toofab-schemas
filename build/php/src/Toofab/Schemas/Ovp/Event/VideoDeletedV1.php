...
{
    const SCHEMA_ID = 'pbj:toofab:ovp:event:video-deleted:1-0-0';
    const SCHEMA_CURIE = 'toofab:ovp:event:video-deleted';
    const SCHEMA_CURIE_MAJOR = 'toofab:ovp:event:video-deleted:v1';
    const MIXINS = [
