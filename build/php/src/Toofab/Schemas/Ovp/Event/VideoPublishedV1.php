...
{
    const SCHEMA_ID = 'pbj:toofab:ovp:event:video-published:1-0-0';
    const SCHEMA_CURIE = 'toofab:ovp:event:video-published';
    const SCHEMA_CURIE_MAJOR = 'toofab:ovp:event:video-published:v1';
    const MIXINS = [
