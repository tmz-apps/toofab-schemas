...
{
    const SCHEMA_ID = 'pbj:toofab:ovp:event:video-created:1-0-0';
    const SCHEMA_CURIE = 'toofab:ovp:event:video-created';
    const SCHEMA_CURIE_MAJOR = 'toofab:ovp:event:video-created:v1';
    const MIXINS = [
