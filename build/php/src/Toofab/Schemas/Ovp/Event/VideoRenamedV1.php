...
{
    const SCHEMA_ID = 'pbj:toofab:ovp:event:video-renamed:1-0-0';
    const SCHEMA_CURIE = 'toofab:ovp:event:video-renamed';
    const SCHEMA_CURIE_MAJOR = 'toofab:ovp:event:video-renamed:v1';
    const MIXINS = [
