...
{
    const SCHEMA_ID = 'pbj:toofab:people:command:delete-person:1-0-0';
    const SCHEMA_CURIE = 'toofab:people:command:delete-person';
    const SCHEMA_CURIE_MAJOR = 'toofab:people:command:delete-person:v1';
    const MIXINS = [
