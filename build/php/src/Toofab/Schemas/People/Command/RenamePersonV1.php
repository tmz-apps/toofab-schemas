...
{
    const SCHEMA_ID = 'pbj:toofab:people:command:rename-person:1-0-0';
    const SCHEMA_CURIE = 'toofab:people:command:rename-person';
    const SCHEMA_CURIE_MAJOR = 'toofab:people:command:rename-person:v1';
    const MIXINS = [
