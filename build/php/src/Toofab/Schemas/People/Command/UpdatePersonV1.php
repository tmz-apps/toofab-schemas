...
{
    const SCHEMA_ID = 'pbj:toofab:people:command:update-person:1-0-0';
    const SCHEMA_CURIE = 'toofab:people:command:update-person';
    const SCHEMA_CURIE_MAJOR = 'toofab:people:command:update-person:v1';
    const MIXINS = [
