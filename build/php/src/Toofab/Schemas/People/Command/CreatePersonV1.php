...
{
    const SCHEMA_ID = 'pbj:toofab:people:command:create-person:1-0-0';
    const SCHEMA_CURIE = 'toofab:people:command:create-person';
    const SCHEMA_CURIE_MAJOR = 'toofab:people:command:create-person:v1';
    const MIXINS = [
