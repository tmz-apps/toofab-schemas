...
{
    const SCHEMA_ID = 'pbj:toofab:people:request:search-people-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:people:request:search-people-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:people:request:search-people-request:v1';
    const MIXINS = [
