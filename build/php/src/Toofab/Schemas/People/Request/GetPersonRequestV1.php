...
{
    const SCHEMA_ID = 'pbj:toofab:people:request:get-person-request:1-0-0';
    const SCHEMA_CURIE = 'toofab:people:request:get-person-request';
    const SCHEMA_CURIE_MAJOR = 'toofab:people:request:get-person-request:v1';
    const MIXINS = [
