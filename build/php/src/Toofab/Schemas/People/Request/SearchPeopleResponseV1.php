...
{
    const SCHEMA_ID = 'pbj:toofab:people:request:search-people-response:1-0-0';
    const SCHEMA_CURIE = 'toofab:people:request:search-people-response';
    const SCHEMA_CURIE_MAJOR = 'toofab:people:request:search-people-response:v1';
    const MIXINS = [
