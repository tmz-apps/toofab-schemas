...
{
    const SCHEMA_ID = 'pbj:toofab:people:request:get-person-history-response:1-0-0';
    const SCHEMA_CURIE = 'toofab:people:request:get-person-history-response';
    const SCHEMA_CURIE_MAJOR = 'toofab:people:request:get-person-history-response:v1';
    const MIXINS = [
