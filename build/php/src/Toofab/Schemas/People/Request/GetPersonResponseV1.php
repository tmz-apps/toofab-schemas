...
{
    const SCHEMA_ID = 'pbj:toofab:people:request:get-person-response:1-0-0';
    const SCHEMA_CURIE = 'toofab:people:request:get-person-response';
    const SCHEMA_CURIE_MAJOR = 'toofab:people:request:get-person-response:v1';
    const MIXINS = [
