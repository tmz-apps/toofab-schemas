...
{
    const SCHEMA_ID = 'pbj:toofab:people:event:person-updated:1-0-0';
    const SCHEMA_CURIE = 'toofab:people:event:person-updated';
    const SCHEMA_CURIE_MAJOR = 'toofab:people:event:person-updated:v1';
    const MIXINS = [
