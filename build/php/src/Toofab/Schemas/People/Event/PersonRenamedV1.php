...
{
    const SCHEMA_ID = 'pbj:toofab:people:event:person-renamed:1-0-0';
    const SCHEMA_CURIE = 'toofab:people:event:person-renamed';
    const SCHEMA_CURIE_MAJOR = 'toofab:people:event:person-renamed:v1';
    const MIXINS = [
