...
namespace Toofab\Schemas\People\Event;
...
{
    const SCHEMA_ID = 'pbj:toofab:people:event:person-deleted:1-0-0';
    const SCHEMA_CURIE = 'toofab:people:event:person-deleted';
    const SCHEMA_CURIE_MAJOR = 'toofab:people:event:person-deleted:v1';
    const MIXINS = [
