...
{
    const SCHEMA_ID = 'pbj:toofab:people:event:person-created:1-0-0';
    const SCHEMA_CURIE = 'toofab:people:event:person-created';
    const SCHEMA_CURIE_MAJOR = 'toofab:people:event:person-created:v1';
    const MIXINS = [
